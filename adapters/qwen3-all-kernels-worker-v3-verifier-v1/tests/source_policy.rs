...
const FE2O3_REVISION: &str = "629465f1a85a1af331a4e285062991f7ab59a5ce";
...
fe2o3-host = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
fe2o3-hsaco-finalize = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
fe2o3-runtime-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
fe2o3-verifier = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
fe2o3-worker-v3-verification-client = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
fe2o3-worker-v3-verification-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
...
[dev-dependencies]
fe2o3-artifact-transaction = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
fe2o3-external-anchor-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "629465f1a85a1af331a4e285062991f7ab59a5ce", version = "=0.1.0" }
proc-macro2 = "=1.0.107"
quote = "=1.0.47"
...
fn lockfile_semantics_policy(source: &str) -> bool {
    ...
    let fe2o3 = Some(
        "git+https://github.com/harsh-nod/fe2o3.git?rev=629465f1a85a1af331a4e285062991f7ab59a5ce#629465f1a85a1af331a4e285062991f7ab59a5ce",
    );
    [
        (
            "ed25519-dalek",
