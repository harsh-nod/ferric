...
const FE2O3_REVISION: &str = "d9f6bbcd089fb4bf7980f807e6550b13daed9178";
...
const REVIEWED_FILE_SHA256: [[u8; 32]; 7] = [
    ...
    [
        143, 49, 153, 187, 83, 197, 41, 81, 24, 228, 252, 117, 205, 202, 75, 17, 239, 191, 53, 83,
        188, 81, 162, 148, 167, 54, 33, 164, 23, 39, 125, 55,
    ],
    [
        208, 244, 67, 134, 91, 38, 247, 59, 245, 109, 50, 81, 117, 156, 216, 164, 202, 228, 108,
        101, 181, 214, 150, 78, 208, 200, 9, 203, 155, 179, 146, 64,
    ],
];
...
fe2o3-hsaco-finalize = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
fe2o3-runtime-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
fe2o3-verifier = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
fe2o3-worker-v3-verification-client = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
fe2o3-worker-v3-verification-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
...
[dev-dependencies]
fe2o3-artifact-transaction = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
fe2o3-external-anchor-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d9f6bbcd089fb4bf7980f807e6550b13daed9178", version = "=0.1.0" }
proc-macro2 = "=1.0.107"
quote = "=1.0.47"
...
fn lockfile_semantics_policy(source: &str) -> bool {
    ...
    let fe2o3 = Some(
        "git+https://github.com/harsh-nod/fe2o3.git?rev=d9f6bbcd089fb4bf7980f807e6550b13daed9178#d9f6bbcd089fb4bf7980f807e6550b13daed9178",
    );
    [
        (
            "ed25519-dalek",
