...
const FE2O3_REVISION: &str = "d8fa0835c64d6574c8589ac3e69e3c34b0350758";
...
const REVIEWED_FILE_SHA256: [[u8; 32]; 7] = [
    ...
    [
        159, 132, 5, 23, 50, 193, 106, 227, 115, 139, 64, 24, 128, 94, 87, 157, 145, 90, 86, 61,
        180, 228, 203, 199, 214, 146, 151, 57, 36, 53, 95, 10,
    ],
    [
    ...
    [
        147, 73, 245, 187, 176, 47, 245, 47, 221, 90, 38, 248, 231, 113, 106, 220, 57, 106, 34,
        203, 195, 48, 46, 100, 79, 0, 182, 204, 128, 157, 31, 172,
    ],
    [
        12, 32, 215, 253, 64, 221, 216, 112, 129, 186, 180, 75, 118, 193, 237, 50, 3, 83, 220, 196,
        91, 5, 244, 140, 75, 185, 112, 166, 248, 15, 104, 66,
    ],
];
const REVIEWED_LIB_NODE_FINGERPRINTS: [[u8; 32]; 23] = [
    ...
    [
        243, 232, 2, 57, 4, 162, 246, 124, 245, 154, 31, 230, 169, 191, 132, 217, 117, 209, 96, 56,
        225, 113, 205, 69, 173, 25, 232, 222, 172, 78, 155, 135,
    ],
    [
        57, 123, 1, 230, 147, 168, 98, 225, 146, 56, 120, 3, 207, 214, 99, 114, 48, 5, 137, 29,
        173, 249, 254, 243, 115, 35, 72, 233, 95, 75, 29, 109,
    ],
    [
        80, 113, 73, 151, 16, 91, 77, 24, 55, 235, 53, 244, 169, 205, 46, 237, 193, 184, 109, 46,
        126, 229, 226, 72, 200, 207, 242, 42, 46, 138, 112, 197,
    ],
    [
...
const REVIEWED_SIBLING_AST_FINGERPRINTS: [[u8; 32]; 4] = [
    ...
    [
        164, 130, 4, 242, 17, 140, 182, 198, 56, 181, 147, 205, 57, 152, 74, 49, 43, 113, 119, 227,
        172, 206, 183, 194, 176, 194, 208, 55, 251, 87, 213, 20,
    ],
    [
...
fe2o3-host = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
fe2o3-hsaco-finalize = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
fe2o3-runtime-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
fe2o3-verifier = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
fe2o3-worker-v3-verification-client = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
fe2o3-worker-v3-verification-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
...
[dev-dependencies]
fe2o3-artifact-transaction = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
fe2o3-external-anchor-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "d8fa0835c64d6574c8589ac3e69e3c34b0350758", version = "=0.1.0" }
proc-macro2 = "=1.0.107"
quote = "=1.0.47"
...
fn lockfile_semantics_policy(source: &str) -> bool {
    ...
    let fe2o3 = Some(
        "git+https://github.com/harsh-nod/fe2o3.git?rev=d8fa0835c64d6574c8589ac3e69e3c34b0350758#d8fa0835c64d6574c8589ac3e69e3c34b0350758",
    );
    [
        (
            "ed25519-dalek",
        ...
        (
            ...
            "1.1.5+spec-1.1.0",
            registry,
            Some("12c0ba9680044b4ce98d391a62094047eada0d64860b80166c39f4a6b5640785"),
        ),
    ]
    .iter()
