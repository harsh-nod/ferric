...
const FE2O3_REVISION: &str = "c94e2101a19c54e3291d2bc092238f4f7e233ca0";
...
const REVIEWED_FILE_SHA256: [[u8; 32]; 7] = [
    ...
    [
        148, 56, 128, 132, 22, 58, 40, 184, 15, 162, 170, 64, 116, 109, 14, 162, 146, 56, 240, 85,
        82, 228, 169, 40, 66, 119, 174, 143, 63, 40, 244, 184,
    ],
    [
        130, 175, 140, 109, 148, 106, 178, 110, 55, 42, 11, 16, 216, 143, 229, 162, 25, 8, 174, 48,
        119, 158, 135, 82, 139, 66, 244, 127, 250, 152, 186, 96,
    ],
];
...
fe2o3-host = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
fe2o3-hsaco-finalize = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
fe2o3-runtime-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
fe2o3-verifier = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
fe2o3-worker-v3-verification-client = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
fe2o3-worker-v3-verification-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
...
[dev-dependencies]
fe2o3-artifact-transaction = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
fe2o3-external-anchor-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c94e2101a19c54e3291d2bc092238f4f7e233ca0", version = "=0.1.0" }
proc-macro2 = "=1.0.107"
quote = "=1.0.47"
...
fn lockfile_semantics_policy(source: &str) -> bool {
    ...
    let fe2o3 = Some(
        "git+https://github.com/harsh-nod/fe2o3.git?rev=c94e2101a19c54e3291d2bc092238f4f7e233ca0#c94e2101a19c54e3291d2bc092238f4f7e233ca0",
    );
    [
        (
            "ed25519-dalek",
