...
const FE2O3_REVISION: &str = "85255498a021ed2b7a1a511f99f577ee4b11d175";
...
const REVIEWED_FILE_SHA256: [[u8; 32]; 7] = [
    ...
    [
        82, 33, 166, 242, 69, 182, 112, 148, 194, 105, 143, 223, 74, 208, 198, 211, 8, 215, 81,
        217, 141, 254, 6, 135, 0, 151, 59, 208, 5, 236, 165, 172,
    ],
    [
        76, 255, 129, 222, 198, 241, 135, 202, 131, 197, 92, 208, 254, 169, 22, 49, 52, 59, 195,
        45, 20, 81, 55, 214, 148, 133, 66, 60, 139, 175, 179, 101,
    ],
];
...
fe2o3-host = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
fe2o3-hsaco-finalize = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
fe2o3-runtime-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
fe2o3-verifier = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
fe2o3-worker-v3-verification-client = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
fe2o3-worker-v3-verification-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
...
[dev-dependencies]
fe2o3-artifact-transaction = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
fe2o3-external-anchor-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
proc-macro2 = "=1.0.107"
quote = "=1.0.47"
...
fn lockfile_semantics_policy(source: &str) -> bool {
    ...
    let fe2o3 = Some(
        "git+https://github.com/harsh-nod/fe2o3.git?rev=85255498a021ed2b7a1a511f99f577ee4b11d175#85255498a021ed2b7a1a511f99f577ee4b11d175",
    );
    [
        (
            "ed25519-dalek",
