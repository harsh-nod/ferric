...
const FE2O3_REVISION: &str = "c9c7036cf98034b638886f54a745701e70ac3571";
...
const REVIEWED_FILE_SHA256: [[u8; 32]; 7] = [
    ...
    [
        190, 99, 19, 69, 144, 32, 83, 7, 228, 196, 98, 224, 61, 76, 111, 241, 46, 16, 15, 220,
        162, 221, 246, 169, 187, 113, 246, 190, 157, 210, 209, 83,
    ],
    [
        71, 240, 98, 74, 230, 241, 171, 146, 142, 72, 221, 192, 245, 212, 38, 152, 207, 203, 198,
        200, 169, 18, 128, 189, 40, 148, 199, 66, 45, 139, 155, 132,
    ],
];
...
fe2o3-host = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
fe2o3-hsaco-finalize = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
fe2o3-runtime-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
fe2o3-verifier = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
fe2o3-worker-v3-verification-client = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
fe2o3-worker-v3-verification-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
...
[dev-dependencies]
fe2o3-artifact-transaction = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
fe2o3-external-anchor-protocol = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "c9c7036cf98034b638886f54a745701e70ac3571", version = "=0.1.0" }
proc-macro2 = "=1.0.107"
quote = "=1.0.47"
...
fn lockfile_semantics_policy(source: &str) -> bool {
    ...
    let fe2o3 = Some(
        "git+https://github.com/harsh-nod/fe2o3.git?rev=c9c7036cf98034b638886f54a745701e70ac3571#c9c7036cf98034b638886f54a745701e70ac3571",
    );
    [
        (
            "ed25519-dalek",
