...
fn wire_is_fixed_bounded_domain_separated_and_strictly_reencoded() {
    ...
    for required in [
        ...
        "pub const M1_ALL_KERNELS_PROTECTED_RECEIPT_SIGNING_DOMAIN_V1",
        "pub const M1_ALL_KERNELS_PROTECTED_RECEIPT_SIGNING_BYTES_V1",
        "Vec::with_capacity(M1_ALL_KERNELS_PROTECTED_RECEIPT_SIGNING_BYTES_V1)",
