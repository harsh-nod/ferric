window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Private draft KV catch-up is integrated and host-tested. The optimized c5/4f6 engineering run completes five real K4 rounds and eight tokens with zero/partial acceptance; full-acceptance catch-up/restore is not observed. The earlier debug GPU-use guard stop remains separate. Current committed source coverage passes without upgrading proof labels. Separate matrix-kernel host tests and paired compiler exports pass, but no new MFMA image or GPU result exists. The retained 0fe 12-kernel image is separate; that image is not GPU-tested. Seven-case numerical tooling is host-validated; actual GPU comparisons remain 1 of 7. The retained numerical rows are not byte-identical and no tolerance is accepted. All 33 M1 gates remain open; no new serving or performance result is claimed.",
