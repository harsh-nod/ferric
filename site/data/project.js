window.FERRIC_PROJECT = Object.freeze({
  ...
  liveC1Checkpoint: {
    ...
    v14: {
      ...
      detail: "Query-hoist v14 retains 13 source-fresh host methods and strict Clippy with actual exit zero, plus its original ten synthetic control tests. A separate emission attempt now passes all nine phases, including 11 synthetic methods. The actual image has 116 explicit bytes, hidden start 120 and 376 total kernarg bytes; 95 SGPR / 37 VGPR, zero spills/private/LDS/AGPR and no dynamic stack. Static def/use review finds the query loads and conversions outside recurring token backedges. The raw hoist flag remains pending and the typed handoff is digest-only: this separate static observation is not detailed typed review, native parity or a same-compiler ablation. No performance gain is claimed, and neither v14 nor v13 changes the measured C1 live route.",
    },
  },
  c1Checkpoint: {
