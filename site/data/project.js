window.FERRIC_PROJECT = Object.freeze({
  ...
  attentionReadiness: [
    ...
    { label: "Combined attention / argmax: host gate passed", state: "integration",
      detail: "The exact ed112e0 host gate passes 42 required commands across 43 actual attempts, with 685 passed test invocations, 34 ignored, eight doctests, 38 source-gate tests, 31 protected source policies and five unchanged inventories. The failed nested-TMP invocation and earlier Clippy failure remain separately archived. Source is unchanged; the Cargo target was warm, not a clean rebuild. Fixed 8/128-output native model checks and the repeated full128 comparison remain pending at this checkpoint. No combined-route metrics, default promotion or change to the matched HTTP results is admitted." },
  ],
  routeReadiness: [
