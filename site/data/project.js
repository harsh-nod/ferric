window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Private authenticated serving now selects the existing S1 K4, K8 or K16 plan. Continuing full acceptance fails closed because authenticated draft KV catch-up is not implemented. All 33 M1 gates remain open; this checkpoint adds no GPU or performance result.",
    ...
    remaining: "Next: attribute and resolve the compiler proof obligation without bypassing it, implement authenticated draft KV catch-up, then qualify the canonical gfx942 target/draft bundle end to end. No native K8/K16 qualification, new TTFT/TPOT/throughput measurement or competitiveness claim is admitted here. Historical measurements below are unchanged.",
  }),
