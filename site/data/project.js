window.FERRIC_PROJECT = Object.freeze({
  ...
  liveC1Checkpoint: {
    ...
    v15: {
      ...
      detail: "Wave RMSNorm v15 passes 20 source-fresh CPU tests: six contract and fourteen host-model tests, with strict Clippy exit zero. The generated lock and source are frozen at c534e35 using fe2o3 61e014a; five own Cargo records are fresh:false and six output files are retained. The CPU oracle covers invalid/nonfinite inputs, convergent reductions, BF16 rounding and rows 1 through 32. FP32 association differs from the old serial fold. A separate emission attempt stopped before compilation: offline metadata could not find smallvec 1.16.0. That failed attempt is retained, and a narrowly scoped dependency-cache correction is being prepared. No image emission, device ABI/resource validation, native/model parity or performance gain is admitted. This CPU result is not a proof of GPU arithmetic or an update to the historical C1 measurements.",
    },
    development: {
