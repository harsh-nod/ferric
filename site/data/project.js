window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Private authenticated S1 K4/K8/K16 draft KV catch-up is integrated and host-tested. Full canonical target/draft prepack and reopen checks pass; aggregate image production and hardware qualification remain pending. All 33 M1 gates remain open; this checkpoint adds no GPU or performance result.",
    integration: Object.freeze({
      compiler: Object.freeze({
        source: "85255498a021ed2b7a1a511f99f577ee4b11d175",
        backendPassed: 539,
        kernelHostPassed: 37,
        emissionState: "overflow-proof-rejected",
        emissionBlock: "bb97",
        emissionSourceFingerprint: "01a6c27889e4",
        emissionLine: 373,
        attributedExpression: "committed_tokens + query_token",
        compilerProgressionOrRegression: "unresolved",
        imageProduced: false,
        detail: "fe2o3 852 is published on main after a fresh rebase, with 539 backend tests passing. Ferric's literal-coordinate kernel repairs pass 37 host tests. The actual d55/852 aggregate retry stays within its storage limits but rejects the paged committed_tokens + query_token arithmetic-overflow proof obligation at semantic bb97, source fingerprint 01a6c27889e4, line 373. A same-source, same-native-MIR comparison stops at a prefill assertion with 829 and this paged assertion with 852. Progression or regression remains unresolved pending isolated assertion checks; different first errors alone establish neither. The earlier 12 GiB resource stop remains retained separately. No image or GPU result was produced.",
      }),
    ...
    remaining: "Next: isolate and resolve the current aggregate overflow-proof rejection, qualify the canonical gfx942 target/draft bundle and exercise the integrated resident catch-up path on hardware. No native K8/K16 qualification, new TTFT/TPOT/throughput measurement or competitiveness claim is admitted here. Historical measurements below are unchanged.",
  }),
