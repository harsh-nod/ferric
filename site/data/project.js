window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Private authenticated S1 K4/K8/K16 draft KV catch-up is integrated and host-tested. Exact bb2/ccfd target-only execution produces four tokens: \" Paris. The capital\". Hardware completion and a one-prompt historical reference spot check are recorded. The canonical 12-root gfx942 image emits and replays exactly. All 33 M1 gates remain open; no new serving or performance result is claimed.",
    ...
    remaining: "Next: complete R29 numerical comparisons and exercise the integrated resident catch-up path. Current-pin engine and checker host validation pass; neither target-only observation qualifies resident speculative serving. No native K8/K16 qualification, new TTFT/TPOT/throughput measurement or competitiveness claim is admitted here. All 33 M1 gates remain open. Historical measurements below are unchanged.",
  }),
