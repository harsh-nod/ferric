window.FERRIC_PROJECT = Object.freeze({
  ...
  liveC1Checkpoint: {
    ...
    development: {
      ...
      detail: "The opt-in V14 full-Qwen canary is integrated in private source; combined controller host validation is pending. The fresh ae267179 runtime worker passes 484 library tests with one unchanged ignore, 31 doctests and strict release Clippy exit zero. All twelve host phases pass; the actual 1,591,144-byte worker and source-bound Cargo receipt are retained. External dependencies were reused, while the current worker record is fresh:false. Worker native qualification remains pending. The checker passed 32 synthetic methods, followed by eight focused wrapper methods for the current worker source/tree and rejection of superseded 61e provenance. These are not model runs. Planned correctness cases use the same binary and retained V14 preload in both resident-wave and query-hoist modes, with 8 or 128 outputs, TP1 and context256. The controller artifact and full-Qwen parity remain pending. The retained V14 image still has compiler 8efd provenance, not ae267; no same-compiler timing claim follows. No default, HTTP measurement, competitive or M1 claim changes; all historical cohorts remain unchanged.",
    },
  },
  c1Checkpoint: {
