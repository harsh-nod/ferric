window.FERRIC_PROJECT = Object.freeze({
  ...
  liveC1Checkpoint: {
    ...
    v15: {
      ...
      detail: "Wave RMSNorm v15 R3 passes 23 source-fresh CPU tests: seven contract and sixteen host-model tests, strict Clippy exit zero and all twelve host/emission phases. Source 39be94d uses actual ae267 compiler tools; the LLVM worker remains an actual 216822 build, not rebuilt-latest. The 11,240-byte image passes static ABI/resource checks: 14 explicit arguments, 96 explicit bytes, hidden start 96 and 352 total kernarg bytes; Wave64, 70 SGPR / 22 VGPR and zero spills/private/LDS/AGPR. Independent static review found no concrete blocker. The handoff is digest-only; detailed typed review remains unadmitted. The earlier 20 source-fresh CPU tests at c534e35 using fe2o3 61e014a remain separately retained, as do the offline-dependency and typed-convergence failures before R3. FP32 association differs from the old serial fold. No native/model parity or performance gain is admitted; static inspection is not a proof of GPU arithmetic or an update to the historical C1 measurements.",
    },
    development: {
