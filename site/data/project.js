window.FERRIC_PROJECT = Object.freeze({
  ...
  milestone: {
    ...
    state: "integration",
    summary:
      "Public fe2o3 main remains 5f46dd2. Local reviewed Ferric integration 30af5c2 pins that exact revision and includes the protected one-shot verifier listener, production-wide bounded queue waits, and the authenticated all-terminal speculative-to-paired-prefill-to-fresh-speculative-window join. The new-window source is DCO-clean, independently reviewed, and its full remote post-export matrix passes. After failing closed on one unsupported lint-only attribute, the synchronized source gate passes 28/28 and canonical regeneration reports exactly 6,951 discovered, 6,854 admitted, 97 unadmitted, and 0 stale bodies; runtime, Instant, and KFD bodies remain explicitly unverified. Kernel focused v20 is fully green with all four frozen SHAs intact. Exact v20 produced no HSACO because its two k.len() evaluations lowered to distinct semantic values; v21 binds one immutable cache_len SSA local and is active. No deployed accepting protected verifier, production R33 backend, Qwen run, measured TTFT or TPOT, baseline, serving endpoint, or HTTP result exists. All 33 M1 gates remain open.",
  },
  envelope: [
    ["Target", "Qwen3-8B"],
    ["Draft", "Qwen3-0.6B"],
    ...
    ["Pages refresh base", "09678a2d013287da4c36ece506166e1baa94b96f; exact public Pages source before this checkpoint update"],
    ...
    ["Local Ferric integration", "latest-fe2 reviewed integration 30af5c2012850afa525539a7e50f8a3b92497f50, tree 841865566065230e28856ecf835475180a36d87e; includes catalog binding 5b23a36, descriptor order e0e79fe, bounded waits e3cfc62, caller-pinned connected-path admission, protected one-shot verifier listener 64ab4fc, production-wide bounded queue waits 1e7695d, and authenticated speculative new windows from DCO candidate 3e4f5d6; local, unpublished, non-final, and provides no current artifact, Qwen, performance, serving, or M1 authority"],
    ["Local validation", "on 30af5c2, the authenticated new-window remote matrix reports a warning-free library check, 576 library tests passed with 5 intentional ignores, 158 doctests, all-target strict Clippy PASS, 25 targeted tests, 13 capture tests, 28 hostile tests, 6 source-policy tests, and 12 rollover tests. Independent token, history, and API source reviews returned GO. Bounded-production-wait component checks at 1e7695d report 11 harness tests, 2 packet tests, 75 qualification tests with 2 intentional ignores, 2 preflight tests, 148 doctests, 8 adapter tests, and 3 adapter doctests. Listener checks at 64ab4fc report 46 service tests with 3 intentional ignores, 88 adapter tests, and 28 source-gate tests. Combined formal inventory regeneration first failed closed on unsupported #[allow(clippy::too_many_lines)]; after narrow closed-allowlist synchronization, the source gate passes 28/28 and canonical regeneration reports exactly 6,951 discovered versus 6,854 admitted, 97 unadmitted, and 0 stale. Runtime, Instant, and KFD bodies remain explicitly unverified, with narrow pure theorem work next. This is scoped integration evidence, not a release qualification, hardware result, or closed M1 gate"],
    ...
    ["Engineering aggregate output", "Focused kernel v20 is fully green against public fe2o3 5f46dd2: prefill profiles 4/4, reference 8/8, source contracts 19/19; paged-decode profiles 4/4, reference 9/9, source contracts 12/12. All four frozen SHAs remain intact. Focused log SHA-256 is 389630423eb58c7de402fbc772c0643a604e7734162f1b7909e220b11e13144d and status SHA-256 is 9a271f2a916b0b6ee6cecb2426f0b3206ef074578be55d9bc94f6f3fe3ab86aa. Exact v20 produced no HSACO and stopped at prefill k.len() - cache_base because the two k.len() evaluations lowered to distinct semantic values; its failure log SHA-256 is 3ebf0b9e5d73758c114b14a48c66fbf0abf7b6febb9344ee5fd87047768b9c18 with exit status 1. The active v21 change binds immutable cache_len = k.len() once and uses that same SSA local in the unchanged guard and subtraction, mirrored and contract-pinned. Exact v19's prior failure evidence remains retained. Unexpected external proof-shape edits were preserved and the current stable snapshot was frozen; neither fact implies correctness. Ferric kernel work remains in progress. No aggregate Worker V3 HSACO, hardware execution, Qwen serving, timing, baseline, artifact authority, or execution authority has been produced"],
    ...
    ["Authenticated target rollover", "paired-prefill rollover is public at 047ee32f6d0bb1861adb211c9ced1f403a22514c. DCO candidate 3e4f5d60db5b69a6335e08b1e44066b9f2a86cd2 is integrated locally at 30af5c2012850afa525539a7e50f8a3b92497f50, which retains exact-slot reincarnation, protected listener 64ab4fc, and bounded production waits 1e7695d. It joins exact all-terminal speculative execution through paired prefill into a fresh speculative window, uses a private move-only whole-page-set token, archives predecessor physical history inertly while resetting active history, and exposes an opaque frozen-timeout Published->Observed->Released surface. The warning-free remote library check, all-target strict Clippy, 576 passed with 5 ignored library matrix, 158 doctests, targeted 25/25, capture 13/13, hostile 28/28, source policy 6/6, and rollover 12/12 all pass. Independent token, history, and API source reviews returned GO. This local integration is unpublished, non-final, not release-qualified, and not evidence of Qwen, endpoint, or performance behavior"],
    ...
    ["Baseline comparison", "No Ferric Qwen timing and no vLLM/SGLang baseline result exist; comparison not run"],
    ["Protected verifier status", "Local integration 64ab4fc contains a reviewed, one-shot protected-verifier listener with scoped remote gates green. The required deployed protected execution profile, concrete checker, signer, supervisor, and production R33 backend remain absent; listener source alone does not create a deployed verifier, protected artifact acceptance, runtime admission, or serving authority"],
    ...
    ["Strict proof release", "Exact local policy v5 for unpublished 829eb98 on ce44dc0 passed all quality gates with closure SHA-256 d52d2b2954fa103bf67f5a9fc72eebb4b315bbc0e1226424480b6412999d8714 and receipt SHA-256 2ab2b3e87a3d32e84d18b9fc1f840a05c6dac415a244ad19bf07e08f619e6641 over 656 files. That receipt is scoped only to 829eb98 on ce44dc0; it does not qualify a future combined or 5f46dd2 tree and closes no M1 gate"],
    ...
    [
      "Current authority",
      "CURRENT=None; no current aggregate Worker V3 HSACO, Qwen token, measured TTFT or TPOT, serving or HTTP endpoint, or vLLM/SGLang comparison exists; all 33 M1 gates remain open",
    ],
  ],
  readiness: [
    {
      ...
      state: "implemented",
      detail:
        "Authenticated model inputs, exact target and draft plans, generational scheduling, paged KV custody, cancellation, completion epochs, and finite speculative lifecycle paths exist in source. Local integration 30af5c2 consumes exact public fe2o3 5f46dd2 and includes a protected one-shot verifier listener, production-wide bounded queue waits, and the reviewed all-terminal speculative-to-paired-prefill-to-fresh-window join with private page-set custody, inert predecessor history, reset active history, and an opaque frozen-timeout lifecycle. It is unpublished, non-final, and not release-qualified. No serving endpoint exists.",
    },
    {
    ...
    {
      label: "Physical target runner",
      state: "implemented",
      detail:
        "Ferric source binds gfx942 through fe2o3 KFD, uploads authenticated model memory, partitions physical KV, constructs the 545-packet target batch, submits, waits, recycles signals, reads compact output, releases pages, and feeds observed tokens into subsequent target decode. Authenticated prefill-to-target-decode rollover is integrated at 047ee32. Missing aggregate and protected-service inputs prevent a Qwen run.",
    },
    {
      label: "Variable-cardinality planner",
      state: "integration",
      detail:
        "Local unpublished, non-final candidate c3fe1f076e6ceded02633fa1e6c6973b5afb4d75 plans reuse=min(old,new), retiring, and fresh slot counts. Focused gates passed 5/5 Rust arithmetic tests, direct Verus 1 function / 33 details / 0 errors, three rejected hostile formula mutations, and branch coverage of 162 modules / 7,526 bodies. Direct data-index candidate c72c2a8ffa47fcc1521ec7f1d2d02ae02f987046 is also local, unpublished, and non-final. Neither implements runtime variable-cardinality wiring or proves transition atomicity.",
    },
    {
      label: "Aggregate 12-kernel source roster",
      state: "integration",
      detail:
        "Ferric's source roster contains 12 K1-K7 entrypoints across seven canonical local Rust modules and 440 exact profiles. Local integration 30af5c2 pins public fe2o3 5f46dd2. Focused v20 is fully green: prefill 4/4 profiles, 8/8 reference, and 19/19 source contracts; paged-decode 4/4 profiles, 9/9 reference, and 12/12 source contracts. All four frozen SHAs remain intact. Exact v20 produced no HSACO and stopped because two k.len() evaluations lowered distinctly; v21's single immutable cache_len SSA local is active, mirrored, and contract-pinned. Unexpected external proof-shape edits were preserved and the current stable snapshot was frozen without implying correctness. Kernel implementation remains in progress, with no aggregate Worker V3 HSACO, admission, or GPU run.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "Candidate c9072b0de61a27be917020baf5eecb4b743734f0 (tree c725eb6e3e6f470fa327f94289509fe910eb83ef) received independent review GO and is integrated at 99cf0d514feb7fccb916f066c645c3a1cf831a0c. The current path adds an internal move-only program-source capability that preserves exact observation, descriptor, compiler-handoff, byte, and allocation identity across engine admission failures. It cannot create Worker V3, protected verification, publication, load, or launch authority, and no production aggregate HSACO has passed through it yet.",
    },
    {
      label: "Non-authoritative target-only engineering smoke",
      state: "integration",
      detail:
        "Public feature-branch checkpoint a2bb2dc adds monotonic-raw controller timing and one truthful request event to the target-only smoke report; it is not on main or final. It records first and terminal token offsets and marks whether TPOT is defined, but excludes artifact, model-memory, and tokenizer setup. The smoke has not run with a current aggregate artifact and is not continuous serving, an HTTP endpoint, a performance result, or M1 evidence.",
    },
    {
      label: "Proof coverage",
      state: "integration",
      detail:
        "Public checkpoint 9431cb4 has an exact source gate of 160 modules and 7,473 executable bodies: 666 directly verified and 6,807 admitted unverified. Its authority-free R33 proof at 3f5b498 covers exactly 20 ordered measures; four exact positive rows verify, and two hostile actual-body mutations for out-of-order measure and abandoned response incorrectly advancing behavior reject. It is public inside checkpoint 9431cb4 but makes no service-conformance claim. Exact local policy v5 for unpublished 829eb98 on ce44dc0 passed all quality gates over a 656-file closure with receipt SHA-256 2ab2b3e87a3d32e84d18b9fc1f840a05c6dac415a244ad19bf07e08f619e6641. Its scope does not include a future combined or 5f46dd2 tree. All 33 M1 closures remain open.",
    },
    {
    ...
    {
      label: "Protected one-shot verifier listener",
      state: "integration",
      detail:
        "Local integration 64ab4fc adds the reviewed caller-pinned, one-shot listener path. Remote gates passed 46 service tests with 3 intentional ignores, 88 adapter tests, 28 source-gate tests, and strict Clippy. It is source integration only: no deployed protected profile, concrete checker, signer, supervisor, production R33 backend, artifact acceptance, or serving authority follows.",
    },
    {
      label: "Accepting protected aggregate artifact",
      state: "open",
      detail:
        "Ferric's private current aggregate publication selection remains None. A protected one-shot listener exists in local source, but the required deployed protected execution profile, concrete checker, signer, supervisor, and production R33 backend are absent. No independent verifier, rollback-currentness, protected acceptance, load, launch, or runtime authority exists.",
    },
    {
      label: "fe2o3 engineering aggregate producer",
      state: "integration",
      detail:
        "Public fe2o3 main is 5f46dd23cfa3cf58118a93ee2bf5e1252903366c (tree 52ec0a254d626102cbfa37b79a906722490cc9d8). Local Ferric integration 30af5c2 pins that exact revision and remains unpublished, non-final, and without release qualification. fe2o3 owns reusable compiler, runtime, KFD, and generic verification transport only; Ferric owns model kernels, inference, and Ferric policy. No Ferric artifact, runtime result, inference result, or correctness authority follows.",
    },
    {
      label: "Ferric connected-path and bounded queue adoption",
      state: "integration",
      detail:
        "Public fe2o3 1167b9c provides connected-filesystem-path Worker V3 V2 admission and 5f46dd2 provides bounded service and authenticated queue waits. Local integration 30af5c2 includes caller-pinned admission, the protected one-shot listener at 64ab4fc, production-wide bounded waits at 1e7695d, and authenticated speculative new windows from 3e4f5d6. Remote listener and engine matrices pass at their recorded heads. Deployment remains in progress because no supervisor, concrete checker, signer, production R33 backend, or deployed protected profile exists. Protected Qwen execution has not run.",
    },
    {
      label: "Bounded production queue waits",
      state: "integration",
      detail:
        "Local integration 1e7695d carries one nonzero timeout through initial submit, retries, rollover custody, and rearmed execution while enforcing progress and wall-clock deadlines. Remote gates passed 569 engine library tests, 11 harness tests, 2 packet tests, 75 qualification tests with 2 intentional ignores, 2 preflight tests, 148 doctests, 8 adapter tests, 3 adapter doctests, and strict Clippy. This is host source qualification, not a GPU, Qwen, serving, or performance result.",
    },
    {
      label: "Production speculative executor",
      state: "integration",
      detail:
        "Candidate 0c2b73bfb8d4e62c100c42a125171c271c8850d8 (tree 00c4b8a04aab2f52af0f43de8a26a7e9564c5568) closed the prior custody findings, compiled the admitted native rollover fixture, passed its exact mi300x check, strict-clippy, unit, binary, and doctest matrix, and received independent review GO. It is integrated at 867f863e223d00e3b304d324e89146e27d2c5c28. This is production-path source integration, not an aggregate artifact, GPU execution, Qwen token, numerical result, performance result, or M1 authority.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "Integration 7f516e0 retains the host-side completion, settlement, page-release, retry, and teardown ownership paths. The R32 command at d67fae3 composes them into one authenticated source vertical without reopening a raw artifact, but the private current selection remains None and a passing reject-only verifier preflight terminates with MissingProtectedVerificationReceipt, so there is no successful current-source R32 trace, authenticated hardware result, or full-Qwen evidence.",
    },
    {
      label: "Authenticated repeat-round same-native lifecycle",
      state: "integration",
      detail:
        "Integration 7f516e0 retains the combined active and parked roster scheduling, KV reservation, workspace preparation, same-native rebind, submit, wait, recycle, readback, completion, page release, retry, and teardown source paths. R32 capture remains first-publication only and excluded from authenticated rearm. Without a current accepted aggregate selection and authenticated run, these paths establish no Qwen, hardware, numerical, performance, or M1 result.",
    },
    {
    ...
    },
    {
      ...
      state: "observed",
      detail:
        "A real mi300x run canonically prepacked and reverified the pinned Qwen3-8B target and Qwen3-0.6B draft snapshot. Bundle 6dfba0acd1c00ce13cec7b5eebb180691bdb8855a7eee89876df2a0a12a2802b and admission 6a396e95e715d1be16bbc27b8c762a9308e40e5355c5bd89b9fc28fb06a1dd16 bind that result. This verifies input packaging only; it is not a protected aggregate artifact, GPU inference run, generated token, or serving result.",
    },
    {
    ...
    },
    {
      ...
      state: "implemented",
      detail:
        "The corrected non-null empty-slice transport is retained in public fe2o3 main 5f46dd2 and is already present in historical b2cce9c consumed by public Ferric feature checkpoint 9431cb4. No accepted aggregate artifact or authenticated full-Qwen run has exercised it through the production path.",
    },
    {
      label: "Generic volatile-load production support",
      state: "implemented",
      detail:
        "Volatile-load support is retained in public fe2o3 main 5f46dd2. This establishes source availability only, not an accepted aggregate artifact, GPU launch, numerical behavior, or Qwen execution.",
    },
    {
    ...
    },
    {
      ...
      state: "open",
      detail:
        "Ferric cannot yet run Qwen through the production path. Its private current aggregate publication selection remains None (CURRENT=None). Real target and draft prepack inputs are verified, and local integration 30af5c2 consumes public fe2o3 5f46dd2 with the reviewed authenticated new-window join integrated. Focused kernel v20 is fully green; exact v20 produced no HSACO at the repeated cache-length evaluation, and v21's single-SSA-local fix is active. Kernel completion, a deployed accepting protected verifier, a production R33 backend, narrow pure theorem work, and release qualification remain in progress. No aggregate HSACO, Qwen token, serving or HTTP endpoint, measured TTFT/TPOT, numerical result, or baseline result exists.",
    },
    {
      label: "vLLM and SGLang baseline comparison",
      state: "open",
      detail:
        "R33 V3 event-backed comparison support is on public feature branch origin/codex/fe2o3-current-main-repin-v1 at a2bb2dc, not on main or final. It retains paired per-request input/output work and recomputes p50/p90/p99 end-to-end latency, TTFT, and TPOT with exact nanosecond units, while preserving throughput and latency comparison. No Qwen measurement, baseline server run, vLLM/SGLang timing, or Ferric comparison result exists.",
    },
    {
      label: "M1 qualification",
      state: "open",
      detail:
        "All 33 M1 exit gates and all 17 assurance properties remain open until their required evidence closes them. Verified prepack inputs, source integration, target rollover, event-backed measurement records, and scoped proof checks do not constitute a current full M1 qualification receipt.",
    },
  ],
  capabilities: {
    runnable: [
      ...
      {
        name: "Physical target runner",
        detail:
          "Source binds gfx942 through KFD, uploads authenticated model memory, partitions physical KV, builds a 545-packet target batch, submits and observes completion, and supports same-shape decode rearm. Missing current artifacts and token feedback keep this from being a current Qwen result.",
      },
    ],
    experimental: [
      {
        name: "Healthy all-terminal queue shutdown",
        detail:
          "Public commit 9eba943 on feature checkpoint 9431cb4 completes healthy all-terminal queue shutdown while preserving authenticated queue and completion custody. It does not implement the lower physical model/KV rebind or establish a serving result.",
      },
      {
        name: "Aggregate 12-kernel compilation unit",
        detail:
          "One device package owns 12 K1-K7 entrypoints across 440 exact profiles and exports their compiler-generated roster in descriptor-table order. The seven family crates reuse those source files as non-authoritative test wrappers; the current aggregate Worker V3 HSACO has not been produced.",
      },
      {
        name: "Typed aggregate source-pin adapter",
        detail:
          "The adapter validates an exact receipt-bearing V2 envelope, target, code-object version, and complete 12-entry plus 12-descriptor symbol sets before projecting exact module, handoff, and manifest identities. Its output is explicitly authority-free.",
      },
      {
      ...
      {
        name: "Production speculative executor",
        detail:
          "Candidate 0c2b73b closed the prior custody findings, passed its exact mi300x matrix, received independent review GO, and is integrated at 867f863. The source path includes a feature-gated admitted native rollover fixture through public scheduling, preparation, submission, completion, and teardown; it has not run with an admitted aggregate artifact or produced GPU, Qwen, numerical, performance, or M1 evidence.",
      },
      {
      ...
      },
      {
        ...
        detail:
          "Public Ferric feature-branch checkpoint 9431cb4 requires fe2o3-production-build-config-v2 with source-isa-summary-v1 observation and consumes historical fe2o3 b2cce9c. Latest public fe2o3 main is 5f46dd2, and the local repin is unpublished and non-final. Compiler, runtime, KFD, and generic transport ownership remains upstream; no aggregate or execution authority follows.",
      },
      {
        name: "R33 V3 serving comparison capture",
        detail:
          "Public feature-branch checkpoint a2bb2dc contains the R33 V3 checker and collector but is not on main or final. It retains exact per-request arrival, first-token, terminal, and token-work events; requires paired work across Ferric, vLLM, and SGLang; and recomputes E2E, TTFT, and TPOT percentiles with exact units. It has not run against Qwen or any baseline, so it creates no performance or M1 result.",
      },
      {
        name: "Non-authoritative engineering aggregate loader",
        detail:
          "Ferric validates the bounded engineering manifest, exact source and tool identities, aggregate digest, target, COV6, and 12-program roster. An internal move-only program-source capability carries exact non-authoritative bytes and lineage into engine admission and is returned intact on failure. It grants no production admission, load, launch, or Qwen authority.",
      },
      {
        name: "Non-authoritative target-only engineering smoke",
        detail:
          "The target-only path includes authenticated target rollover, emitted-token feedback, and one monotonic-raw single-request timing event. It has not executed with the current aggregate path and is neither continuous serving nor HTTP, so it has produced no Qwen token, measured TTFT/TPOT, or endpoint result.",
      },
      {
        name: "Protected verifier service foundation",
        detail:
          "Local integration 64ab4fc adds a reviewed one-shot listener, and its scoped service, adapter, source-gate, and strict-Clippy checks pass. It remains non-deployed source: the protected execution profile, concrete checker, signer, head-store, supervisor, production R33 backend, and runtime authority are absent.",
      },
      {
        name: "Qualified proof ledger",
        detail:
          "Retained release 7f516e0 remains the last full release receipt. Public feature checkpoint 9431cb4 has an exact source-gate inventory of 160 modules and 7,473 executable bodies: 666 directly verified and 6,807 admitted unverified. It retains the canonical weight-role proof and negative mutation evidence first published at 756e813 and integrates the independent, authority-free R33 daemon lifecycle proof at 3f5b498. Four exact positive rows verify, while out-of-order measure and abandoned response incorrectly advancing mutations are rejected. A fresh full release receipt and all M1 evidence closures remain open.",
      },
      {
    ...
    roadmap: [
      ...
      },
      {
        ...
        detail:
          "The public Ferric feature branch consumes historical fe2o3 b2cce9c and includes authenticated target rollover plus healthy all-terminal shutdown, but is not main or final. Latest public fe2o3 is 5f46dd2; preserve fail-closed ownership while integrating and qualifying the unpublished repin against the eventual accepted aggregate artifact.",
      },
      {
      ...
      },
      {
        ...
        detail:
          "Public fe2o3 b4f600a supplies checked DisjointBlockComponentIndex projection, ce44dc0 adds LLVM 22 Worker compatibility, and 5f46dd2 is the latest public main. Ferric must publish an exact repin and rerun before structural inspection of any 12-entry Worker V3 output. A current protected publication still needs independent compiler, finalizer, verifier, and rollback authority before an artifact can enter production runtime acceptance.",
      },
      {
      ...
      },
      {
        ...
        detail:
          "Finish the full release qualifier over current-source locks and source-policy bindings before exposing runtime authority. The aggregate producer must retain production config V2 and source-isa-summary-v1 observation, and the non-authoritative engineering capability must remain outside production admission.",
      },
      {
        name: "Complete Qwen execution",
        detail:
          "Produce and admit the aggregate HSACO, provision the protected execution profile and service socket, then run the implemented authenticated target rollover and token-feedback path. Only a real run can report a Qwen token, TTFT, or TPOT.",
      },
      {
        name: "Compare with vLLM and SGLang",
        detail:
          "Obtain the three exclusive GPU slots and real lifecycle adapters required by R33 V3, then run its frozen matched Ferric, vLLM, and SGLang workload. The event-backed schema is implemented, but no Qwen timing or baseline comparison has started.",
      },
      {
  ...
  validation: {
    host: {
      ...
      detail:
        "Independent audit approved the authenticated first-publication S1/K4 command from aggregate selector intake through queue teardown and V2 partial-capture publication. Remote mi300x formatting, policy, checks, strict clippy, and all-target tests passed. No successful R32 hardware trace was produced because the private current aggregate selection is None and the zero-state protected verifier rejects every request, with MissingProtectedVerificationReceipt as the sole terminal result after a passing preflight. This qualifies source and host policy only, not hardware execution, protected acceptance, Qwen execution, performance, m1.r32, or M1.",
    },
    proof: {
    ...
    hardware: {
      ...
      result: "PASS: 3,072 / 3,072 exact; max ULP 0",
      detail:
        "This historical HIP result covers one older SwiGLU artifact only. It did not exercise the current aggregate source, an accepting protected aggregate source pin, the production KFD path, the complete Qwen graph, or token generation.",
    },
    transitions: [
      ["Prefill S1/T128", "Decode S1/C8192", "implemented"],
    ...
    limitation:
      "Authenticated target-decode rollover is integrated at 047ee32, and healthy all-terminal queue shutdown plus the authority-free supervised R33 wire foundation at 66b8547 are public inside checkpoint 9431cb4, but none has executed with an accepted aggregate artifact. Reviewed lower physical all-terminal model/KV rebind and fresh-window source is integrated locally at 30af5c2. Every unlisted native transition remains fail-closed, and no row is a serving or performance claim.",
  },
  teams: [
    {
      name: "Integration",
      scope: "fe2o3 publication, Ferric repin, merges, remote end-to-end qualification",
      state: "integration",
      status: "Making progress",
      completed:
        "Public fe2o3 main is 5f46dd2. Local reviewed Ferric integration 30af5c2 pins that exact revision and includes catalog binding 5b23a36, descriptor order e0e79fe, protected one-shot listener 64ab4fc, production-wide bounded queue waits 1e7695d, and reviewed authenticated speculative new windows from 3e4f5d6.",
      current:
        "Integration 30af5c2 is local, unpublished/non-final. Listener checks pass 46 service tests with 3 ignores, 88 adapter tests, and 28 source-gate tests. New-window checks pass a warning-free library check, 576 library tests with 5 ignores, 158 doctests, all-target strict Clippy, targeted 25/25, capture 13/13, hostile 28/28, source policy 6/6, and rollover 12/12. No release qualification exists.",
      blockedBy:
        "No active team is idle or blocked; production execution still depends on an aggregate HSACO, a deployed protected profile, concrete checker/signer/supervisor, and the production R33 backend.",
      next:
        "Integrate the kernel and authenticated new-window work, regenerate combined formal inventories, qualify the exact remote tree, and publish only after identities and receipts agree.",
      validation: "fe2o3 5f46dd2 public; Ferric 30af5c2 local, unpublished, non-final; DCO/diff clean and scoped gates green; release qualification open",
    },
    {
      name: "Kernel",
      scope: "Ferric-owned Qwen kernels, profile catalogs, aggregate artifact production",
      state: "integration",
      status: "Making progress",
      completed:
      ...
      current:
        "Against local integration 30af5c2 and public fe2o3 5f46dd2, focused v20 is fully green: prefill 4/4 profiles, 8/8 reference, 19/19 source contracts; paged-decode 4/4 profiles, 9/9 reference, 12/12 source contracts. All four frozen SHAs remain intact. Log SHA-256 389630423eb58c7de402fbc772c0643a604e7734162f1b7909e220b11e13144d and status SHA-256 9a271f2a916b0b6ee6cecb2426f0b3206ef074578be55d9bc94f6f3fe3ab86aa are pinned. Exact v20 produced no HSACO and stopped when repeated k.len() evaluations lowered to distinct semantic values; failure log 3ebf0b9e5d73758c114b14a48c66fbf0abf7b6febb9344ee5fd87047768b9c18 and exit status 1 are pinned. V21 binds immutable cache_len once for the unchanged guard and subtraction, mirrored and contract-pinned. Unexpected external proof-shape edits were preserved and the current stable snapshot was frozen without implying correctness. Kernel implementation remains in progress; no aggregate HSACO has been produced.",
      blockedBy:
      ...
      next:
        "Qualify v21, rerun exact compilation, structurally inspect any aggregate on 5f46dd2 without weakening authorization, and keep every model kernel in Ferric.",
      validation: "focused v20 green: prefill 4/4 + 8/8 + 19/19, paged-decode 4/4 + 9/9 + 12/12, four frozen SHAs intact; exact v20 stopped at distinct cache-length values; v21 active; no HSACO, admission, or GPU result",
    },
    {
      name: "Engine",
      scope: "Qwen execution, physical KV, KFD lifecycle, token feedback, measurement",
      state: "integration",
      status: "Making progress",
      completed:
        "Ferric includes authenticated prefill-to-target-decode rollover at 047ee32, healthy all-terminal queue shutdown at 9eba943, a protected one-shot listener at 64ab4fc, production-wide bounded queue waits at 1e7695d, and reviewed authenticated speculative new-window source from 3e4f5d6 integrated at 30af5c2.",
      current:
        "Local unpublished/non-final integration 30af5c2 consumes exact fe2o3 5f46dd2 and covers the exact all-terminal speculative->paired-prefill->fresh speculative window path with a private move-only whole-page-set token, inert predecessor physical history and reset active history, plus an opaque frozen-timeout Published->Observed->Released surface. Protected deployment remains in progress because the supervisor, concrete checker, signer, deployed profile, and production R33 backend are absent.",
      blockedBy:
      ...
      next:
        "Implement and qualify the production R33 backend and protected authority on the integrated authenticated new-window path; Qwen and baseline timing come only after a real run.",
      validation: "30af5c2 is DCO/diff clean; warning-free remote library check, all-target strict Clippy, 576 passed / 5 ignored, 158 doctests, targeted 25/25, capture 13/13, hostile 28/28, source policy 6/6, rollover 12/12, and token/history/API source-review GOs; no release qualification, HSACO, hardware, serving, or comparison result",
    },
    {
      name: "Verification",
      scope: "Verus refinement, executable-constructor linkage, mutation and policy evidence",
      state: "integration",
      status: "Making progress",
      completed:
      ...
      current:
        "Combined formal inventory regeneration on integration line 30af5c2 initially failed closed on unsupported #[allow(clippy::too_many_lines)] in the new authenticated submit body. After narrow closed-allowlist synchronization, the source gate passes 28/28 and canonical regeneration reports 6,951 discovered versus 6,854 admitted: exactly 97 unadmitted and 0 stale. Runtime, Instant, and KFD bodies remain explicitly unverified; narrow pure theorem work is next. The engine gates pass strict Clippy, and independent token, history, and API source reviews returned GO. No release receipt, runtime-atomicity proof, or deployment-conformance claim exists.",
      blockedBy:
      ...
      next:
        "Add the narrow pure theorem model without making claims over Runtime, Instant, or KFD effects, then regenerate exact proof receipts before any public completion claim.",
      validation:
        "30af5c2 source gate 28/28 and canonical regeneration: 6,951 discovered / 6,854 admitted / 97 unadmitted / 0 stale; runtime, Instant, and KFD explicitly unverified; release qualification open",
    },
  ],
  recentProgress: [
    {
      commit: "30af5c2012850afa525539a7e50f8a3b92497f50",
      title: "Advance the local integration through authenticated new windows",
      state: "integration",
      detail:
        "Local reviewed integration 30af5c2 consumes exact public fe2o3 5f46dd2 and contains the DCO-clean authenticated speculative new-window tree from 3e4f5d6. Its complete scoped remote matrix and three independent source reviews pass. Canonical inventory regeneration reports 6,951 discovered, 6,854 admitted, 97 unadmitted, and 0 stale, with runtime, Instant, and KFD bodies explicitly unverified. This remains unpublished, non-final, and without GPU, Qwen, serving, performance, or M1 authority.",
    },
    {
      commit: "3e4f5d60db5b69a6335e08b1e44066b9f2a86cd2",
      title: "Integrate authenticated speculative new windows",
      state: "integration",
      detail:
        "DCO candidate 3e4f5d6 is integrated locally at 30af5c2. It joins exact all-terminal speculative execution through paired prefill into a fresh speculative window with private whole-page-set custody, inert predecessor history, reset active history, and opaque frozen-timeout publication lifecycle. The warning-free remote library check, all-target strict Clippy, 576 passed / 5 ignored library matrix, 158 doctests, targeted 25/25, capture 13/13, hostile 28/28, source policy 6/6, and rollover 12/12 pass; three independent source reviews returned GO. No hardware, Qwen, serving, performance, or M1 authority follows.",
    },
    {
      commit: "1e7695d9517a9711389a907c1ebbc2a6bc76249a",
      title: "Bound production queue waits",
      state: "integration",
      detail:
        "Local reviewed integration retains one nonzero timeout through production submit, retry, rollover, and rearm paths. Remote checks pass 569 engine library tests, 11 harness tests, 2 packet tests, 75 qualification tests with 2 intentional ignores, 2 preflight tests, 148 doctests, 8 adapter tests, 3 adapter doctests, and strict Clippy. It creates no GPU, Qwen, serving, or performance authority.",
    },
    {
      commit: "64ab4fc98ecc64e78b4591197a47674f27bc992e",
      title: "Integrate the protected one-shot verifier listener",
      state: "integration",
      detail:
        "Local reviewed source adds a caller-pinned one-shot protected-verifier listener. Remote checks pass 46 service tests with 3 intentional ignores, 88 adapter tests, 28 source-gate tests, and strict Clippy. A supervisor, concrete checker, signer, production R33 backend, and deployed protected profile remain absent.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "The direct choice data ordinal is bound in local unpublished, non-final source. It remains separate from the current integration and policy receipt and provides no combined qualification, runtime variable-cardinality atomicity, Qwen, serving, or M1 authority.",
    },
    {
    ...
    {
      commit: "c3fe1f076e6ceded02633fa1e6c6973b5afb4d75",
      title: "Complete the local variable-cardinality planner",
      state: "integration",
      detail:
        "Local unpublished, non-final planner source passed 5/5 Rust arithmetic tests, direct Verus 1 function / 33 details / 0 errors, three rejected hostile formula mutations, and branch coverage of 162 modules / 7,526 bodies. These focused gates cover cardinality formulas only; runtime variable-cardinality wiring and transition atomicity remain unimplemented and unproved.",
    },
    {
    ...
    },
    {
      ...
      repository: "https://github.com/harsh-nod/fe2o3",
      title: "Publish LLVM 22 Worker compatibility",
      state: "implemented",
      detail:
        "Public fe2o3 updates reusable Worker compiler handling for LLVM 22. This is generic compiler support; no Ferric aggregate output or runtime result follows.",
    },
    {
      commit: "b4f600ae92288ccf1662ddff40d71fefba631777",
      repository: "https://github.com/harsh-nod/fe2o3",
    ...
    },
    {
      ...
      title: "Integrate exact new-window identity checks locally",
      state: "integration",
      detail:
        "Local unpublished, non-final Ferric integration adds exact-slot reincarnation, new-window physical invariants, speculative-retirement preflight, engineering timing, and authenticated executable-catalog binding. Focused remote tests and strict Clippy passed, but no combined current qualification, public checkpoint, hardware run, or serving result exists.",
    },
    {
      commit: "829eb98ba11c645958ef762a01da4c81c4bf795b",
      title: "Qualify the local policy repin candidate",
      state: "qualified",
      detail:
        "Exact local policy v5 for unpublished 829eb98 on ce44dc0 terminated status 0 with all quality gates passed over 656 files. Closure SHA-256 is d52d2b2954fa103bf67f5a9fc72eebb4b315bbc0e1226424480b6412999d8714; receipt SHA-256 is 2ab2b3e87a3d32e84d18b9fc1f840a05c6dac415a244ad19bf07e08f619e6641. This qualification is scoped only to that exact local tree and base; it does not qualify a future combined or 5f46dd2 tree and closes no M1 gate.",
    },
    {
      commit: "e18eb0e06473fabc6dbfe4cef80b692e34b04a22",
      title: "Stage the local authenticated selector candidate",
      state: "integration",
      detail:
        "Local unpublished, non-final source acquires the exact selector before binding and preserves typed custody on failure. Focused checks passed; it is not integrated with the current repin and grants no protected runtime or serving authority.",
    },
    {
      commit: "a18de34ac7ffb39d8eaa632e1deb07b3dd1df274",
      title: "Stage the local physical new-window proof candidate",
      state: "integration",
      detail:
        "Local unpublished, non-final proof and inventory work covers physical new-window construction and related identities. Focused proof and test gates passed, but integration, regenerated inventories, and combined current qualification remain pending.",
    },
    {
      commit: "b2cce9c271e85a97c35ce7a1ccffe17bb330f07c",
      repository: "https://github.com/harsh-nod/fe2o3",
      title: "Historical Ferric-consumed fe2o3 compiler/runtime base",
      state: "implemented",
      detail:
        "Public Ferric feature checkpoint 9431cb4 still consumes historical fe2o3 b2cce9c, tree e28a3a8. Public fe2o3 main has since advanced through b4f600a, ce44dc0, 1167b9c, and 5f46dd2. This upstream history contains reusable compiler/runtime/KFD work only; Ferric-specific model kernels, inference, and policy remain in Ferric.",
    },
    {
      commit: "9431cb4638401718b8085bcf258a390650c719ef",
      title: "Publish the verified Ferric feature checkpoint",
      state: "integration",
      detail:
        "Public feature-branch checkpoint 9431cb4, tree 09c4816, consumes historical fe2o3 b2cce9c and integrates ff2ca04 checked SwiGLU block indices, 9eba943 healthy all-terminal queue shutdown, 66b8547 authority-free R33 wire support, and the 3f5b498 lifecycle proof. Its source gate covers 160 modules and 7,473 executable bodies: 666 directly verified and 6,807 admitted unverified. It is not on main or final and creates no aggregate HSACO, GPU, Qwen, serving, or M1 result.",
    },
    {
      commit: "ff2ca043600550ec72957ac99bae64251f2e4184",
    ...
    },
    {
      ...
      title: "Complete healthy all-terminal queue shutdown",
      state: "implemented",
      detail:
        "The authenticated engine now closes healthy all-terminal queue shutdown while retaining typed lifecycle custody. This is source progress only; lower physical model/KV new-window rebind, hardware execution, serving, and M1 evidence remain open.",
    },
    {
      commit: "3f5b4982fa08c4488ff13bb7db37bcbb0ab8368f",
      title: "Prove the R33 daemon lifecycle",
      state: "verified",
      detail:
        "The executable, service-independent model proves start, ready, exactly 20 ordered measures, delivered versus abandoned responses, faulted exact-stop-only recovery, and backend-free exact stop replay. Four exact positive rows verify and two hostile actual-body mutations reject. It is public inside checkpoint 9431cb4 but grants no service conformance, runtime authority, or final proof receipt.",
    },
    {
      commit: "66b8547ab7ce1572d29557d2e9c16d58b2b6f41f",
      title: "Add the supervised R33 wire foundation",
      state: "implemented",
      detail:
        "The authority-free supervised R33 wire and service foundation is public inside checkpoint 9431cb4. It is not the lower physical model/KV rebind, has no protected runtime authority, and is not a serving endpoint.",
    },
    {
      commit: "f8f8ce60e23a1331a83606029fca2d0958bd3157",
      title: "Bind the all-terminal new-window transaction",
      state: "implemented",
      detail:
        "The public control plane retains the completed predecessor roster, validates exact successor scheduler authority, commits registry publication only after exact physical publication, and exposes retry plus predecessor restore custody. The lower physical model/KV rebind remains unavailable, so the production runner returns retryable RolloverUnavailable.",
    },
    {
      commit: "a2bb2dc9f0087d4573d58b7c0f5b15aee3b3245b",
      title: "Combine the current Ferric M1 integration",
      state: "integration",
      detail:
        "Public feature-branch checkpoint a2bb2dc combines the public fe2o3 repin, direct-publication proof, authenticated target rollover, and R33 V3 event-backed timing work. It is not on main or final, has produced no aggregate HSACO or Qwen timing, and closes none of the 33 M1 gates.",
    },
    {
      commit: "047ee32f6d0bb1861adb211c9ced1f403a22514c",
      title: "Activate authenticated target rollover",
      state: "implemented",
      detail:
        "Ferric implements the authenticated Target8B PrefillS1T128 to DecodeS1C8192 scheduler and physical rollover route at 047ee32. It is present in public feature-branch checkpoint a2bb2dc, not on main or final, but has not run with a current aggregate artifact and therefore creates no Qwen, numerical, timing, serving, or M1 result.",
    },
    {
      commit: "6a982d466bd4cb7e44c90390406d78a811d7c12a",
    ...
    },
    {
      ...
      repository: "https://github.com/harsh-nod/fe2o3",
      title: "Historical compiler support checkpoint",
      state: "integration",
      detail:
        "Earlier fe2o3 branch 80aaaf3 included then-current origin/main c58785c and reviewed guarded-subtraction support e745bc75c. Later public heads d8fa0835 and b2cce9c superseded it; current public main is 5f46dd2. This historical checkpoint creates no HSACO, hardware, serving, comparison, or M1 result.",
    },
    {
      ...
      state: "qualified",
      detail:
        "Pushed checkpoint 4796efd, tree c8b98c6, adds exact profile-extent guards in the RoPE and paged-KV kernels on top of compact-completion and prefill-guard work. RoPE source SHA-256 is 3694d0fb2eedce6b94ca3e1ef427dcfd5d4621cd91cb1fb3ebd5e61a1607d306. Remote rustfmt, rope-wrapper 22/22, and aggregate 21/21 passed, and independent review returned GO. The post-guard aggregate attempt remains pending, so no HSACO, current Qwen token, hardware result, performance result, or M1 evidence follows.",
    },
    {
      commit: "efb8931287f4eb34dcd636594b31aa7a5a78a0cb",
      repository: "https://github.com/harsh-nod/fe2o3",
      title: "Qualify the latest durable compiler candidate",
      state: "qualified",
      detail:
        "Candidate efb8931, tree 4718138, includes current fe2o3 origin/main 57b7d21. Remote KFD 295, compiler 489, debug-protocol, closure 12, and worker evidence is green. Its exact aggregate attempt with pre-guard Ferric 362b275 crossed prefill and rope_kv.rs lines 212 and 213, then exited 1 at rope_kv.rs:143, `rows * query_columns`, with zero connects and zero outputs. No artifact or execution authority follows.",
    },
    {
      commit: "31b6f4989d961667900bff39935c75024316a2dc",
      title: "Historical R33 V2 collector checkpoint",
      state: "integration",
      detail:
        "The earlier R33 V2 collector is superseded at public feature-branch checkpoint a2bb2dc by V3 retained request events and recomputed E2E, TTFT, and TPOT percentiles. The checkpoint is not on main or final. Neither collector has run on Qwen, and no baseline or comparison result exists.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "This unpublished integration contains the independently reviewed GO speculative executor at 0c2b73b and the independently reviewed GO engineering aggregate loader at c9072b0. The loader is explicitly observation-only, CURRENT=None remains unchanged, and no aggregate HSACO, Qwen token, hardware result, numerical result, performance result, comparison result, or M1 authority follows.",
    },
    {
      commit: "c9072b0de61a27be917020baf5eecb4b743734f0",
      title: "Approve non-authoritative aggregate observation admission",
      state: "qualified",
      detail:
        "Independent review returned GO for the exact loader candidate and it was merged at 99cf0d5. The loader validates a bounded descriptor-relative engineering manifest, exact gfx942:xnack-/COV6 aggregate structure, and the 12-program catalog, but exposes only callback-scoped borrowed custody and cannot create Worker V3, protected verifier, publication, load, launch, or Qwen authority.",
    },
    {
      commit: "0c2b73bfb8d4e62c100c42a125171c271c8850d8",
      title: "Approve and integrate the speculative executor",
      state: "qualified",
      detail:
        "The exact candidate closed the earlier custody and lifecycle findings, passed the remote mi300x check, strict-clippy, unit, binary, and doctest matrix, and received independent review GO. It is integrated at 867f863. Its admitted native rollover fixture is compiled but has not run because no admitted aggregate HSACO exists; no hardware or Qwen result follows.",
    },
    {
      commit: "41abaa0c97839f4cae8b1d0527ad7801fc4fa51e",
      repository: "https://github.com/harsh-nod/fe2o3",
    ...
    },
    {
      ...
      repository: "https://github.com/harsh-nod/fe2o3",
      title: "Freeze the engineering aggregate manifest schema",
      state: "integration",
      detail:
        "This pushed fe2o3 head freezes the bounded manifest schema and sealed tool/source lineage used by Ferric's engineering loader. Exact focused CLI, proxy, source-closure, and finalizer checks passed on mi300x. A real aggregate attempt then reached the first compiler semantic gap at core::intrinsics::fabs. Pushed candidate 41abaa0c97839f4cae8b1d0527ad7801fc4fa51e addresses that gap; its focused MI300X matrix is green, while broader and real-aggregate qualification and Ferric integration remain open.",
    },
    {
    ...
    },
    {
      ...
      repository: "https://github.com/harsh-nod/fe2o3",
      title: "Historical absolute-deadline checkpoint",
      state: "qualified",
      detail:
        "At this earlier checkpoint, public candidate ff21f24 (tree 861ad57c9725d06a5bed14739269ddd20b70e86a), based on then-current main 308d8fa, passed exact-archive qualification on mi300x. Later engineering-producer work supersedes it as the active compiler line; the historical result grants no protected aggregate, Qwen, hardware, numerical, performance, or M1 authority.",
    },
    {
      commit: "f300ab8b174ff4e71d5d5fdaf038741db159907e",
      title: "Historical rejection of the first executor candidate",
      state: "integration",
      detail:
        "At this earlier checkpoint, independent re-review found four P1 custody and lifecycle escapes despite a green test matrix, so f300ab8 was NO-GO. Superseding candidate 0c2b73b closed those findings, received independent GO, and is integrated at 867f863. Neither checkpoint establishes hardware, Qwen, numerical, performance, or M1 authority.",
    },
    {
    ...
    },
    {
      ...
      title: "Preflight aggregate verifier common custody",
      state: "qualified",
      detail:
        "After constructing the private typed-request projection, the zero-state backend independently revalidates the exact-pinned finalizer derivation from the borrowed replay, validates common multi-root compiler proof inputs, and validates common multi-root target lineage by borrowing those inputs. The inferred move-only owners reach the private rejection helper together, whose sole terminal result remains MissingProtectedVerificationReceipt. Strict mi300x qualification passed over a 603-file closure at 4920f55d8c98681e6ee154b8d5bba64f80d17241e89e07505626f9f365a8a2e2; receipt fbdb2ad3f3acdf9f46480be16e993cee2ededf548be22e6e35b787749ed65d21 and log 1a5bb9049f496d1f74f4233147b4a72b588333d4dfbf30ae1658fcb0d67c47fa retain the result. Exact-head runs 33599537169 and 33599537184 are green. No protected acceptance, runtime, hardware, Qwen, numerical, performance, or M1 authority follows.",
    },
    {
      commit: "75c5f724fbc7928bf1b231a86aec0f1d5fdcc3f9",
      title: "Project the aggregate pending verifier request",
      state: "qualified",
      detail:
        "The zero-state backend now builds a private, reject-only projection from the exact typed aggregate request, preserves absent per-entry facts as Option::None, and unconditionally returns MissingProtectedVerificationReceipt. Strict mi300x qualification passed over a 603-file closure at 19d090e8f60e813533d60bfdf7133b2829ede3f6fac780adc8e27dc61fbd7e0f; receipt b03c3aaeca723d9100669c457d3a49864c2e13bfafc9a99fd5034eb915033673 and log ed9d8aec91f98016cfa44f981c6b04bf0be2bbb005888ae7a0097d7af128ae07 retain the result. Both exact-head workflows are green. No verifier, runtime, hardware, Qwen, performance, or M1 authority follows.",
    },
    {
    ...
    },
    {
      ...
      state: "qualified",
      detail:
        "The generation-1 S1/K4 completion owner now performs four ordered draft-row copies followed by one target copy and a specialized semantic join. Reused generations, absent capture, coordinate or token drift, copy failures, and semantic failures retain custody and fail closed; the path is excluded from rearm and explicitly partial-non-evidence. Independent audit approved it, and remote mi300x fmt, policy, check, clippy, and library tests passed with 475 passed, 0 failed, and 5 ignored. No hardware or Qwen execution follows.",
    },
    {
      commit: "6a20199b71283c8d4c88a94c9489823ab15630b3",
      title: "Align the source gate with the aggregate roster",
      state: "implemented",
      detail:
        "The source gate now requires the exact compiler descriptor-table order exported by the aggregate 12-kernel package. This closes source-policy drift only; protected aggregate acceptance, authenticated Qwen execution, and every M1 exit gate remain open.",
    },
    {
      commit: "8d95881fdbf69d5e5f700c6e0bb836176d0942a2",
      title: "Require the aggregate producer policy",
      state: "implemented",
      detail:
        "CI and release qualification invoke the aggregate Worker V3 producer-policy suite. The suite exercises identity, custody, bounds, and hostile-policy behavior without granting compiler-origin, verifier, publication, load, launch, Qwen, or M1 authority.",
    },
    {
      commit: "e57c42523050922ad76538150df691cc5ab975a7",
      title: "Add the aggregate Worker V3 build producer",
      state: "implemented",
      detail:
        "The bounded producer holds exact committed device and typed-adapter sources, invokes the source-prebound adapter, inspects the aggregate artifact namespace, and emits an observational record. Its explicit nonclaims exclude protected compilation, durable publication, GPU execution, Qwen, performance, and M1.",
    },
    {
      commit: "5514afe176a090aa3f1da9e5354799bb4ca5a8b3",
      title: "Own all 12 M1 roots in one aggregate package",
      state: "implemented",
      detail:
        "One selected Rust compilation unit now owns all 12 attributed M1 roots across seven canonical source modules and exports the exact compiler-generated roster. Historical family packages are non-authoritative wrappers; no accepted production artifact or execution follows.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "K2 source qualification was retained through earlier implementation 5f40e40 and its scoped package checks passed on mi300x. The source is now owned by the aggregate package; accepted production artifacts, authenticated KFD, hardware numerics, performance, Qwen, and M1 remain open.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "Earlier implementation 5f40e40 retained the attributed Qwen3 GEMM and embedding merge against fe2o3 b5374c6e. The current aggregate package owns that source; no accepted production artifact, authenticated KFD result, Qwen run, performance result, or M1 authority follows.",
    },
    {
    ...
    },
    {
      ...
      state: "integration",
      detail:
        "This commit began the standalone K2 package. Qualified revision adc01968 replaced the XOR tree with lane-zero ascending serial FP32 accumulation and was retained through implementation 5f40e40. The current aggregate package reuses that source; production acceptance, authenticated KFD, hardware results, and performance remain open.",
    },
    {
  ...
  boundaries: {
    ferric: [
      ...
      "Public feature branch origin/codex/fe2o3-current-main-repin-v1 contains 9431cb4638401718b8085bcf258a390650c719ef, tree 09c48165b19883aebbebd2e77b827794cd039164; it is not on main or final and closes none of the 33 M1 gates",
      "Local reviewed Ferric integration 30af5c2012850afa525539a7e50f8a3b92497f50, tree 841865566065230e28856ecf835475180a36d87e, includes protected one-shot listener 64ab4fc98ecc64e78b4591197a47674f27bc992e, production-wide bounded waits, and reviewed authenticated speculative new windows from DCO candidate 3e4f5d60db5b69a6335e08b1e44066b9f2a86cd2; it is unpublished and has no current or serving authority",
      "Direct data-index candidate c72c2a8ffa47fcc1521ec7f1d2d02ae02f987046 is also local, unpublished, and non-final",
      "Exact local policy v5 for 829eb98 on ce44dc0 passed all quality gates over a 656-file closure; closure d52d2b2954fa103bf67f5a9fc72eebb4b315bbc0e1226424480b6412999d8714 and receipt 2ab2b3e87a3d32e84d18b9fc1f840a05c6dac415a244ad19bf07e08f619e6641 bind only that scope, not a future combined or 5f46dd2 tree, and close no M1 gate",
      ...
      "A historical local post-ff2ca04 aggregate rerun using public fe2o3 b2cce9c source stopped before Worker or link at missing DisjointBlockComponentIndex production expansion; it was not a published Ferric result. Public fe2o3 b4f600a now supplies that generic checked projection. Focused v20 is fully green against public fe2o3 5f46dd2 with all four frozen SHAs intact; exact v20 produced no HSACO at distinct cache-length semantic values, and v21's single-SSA-local fix is active",
      ...
      "Healthy all-terminal queue shutdown is public at 9eba943 inside 9431cb4; reviewed lower physical model/KV rebind and fresh-window source from 3e4f5d6 is integrated locally at 30af5c2",
      "Authenticated Target8B PrefillS1T128 to DecodeS1C8192 rollover is implemented at 047ee32f6d0bb1861adb211c9ced1f403a22514c and retained in public feature checkpoint 9431cb4, not on main or final; it has not run with an accepted aggregate artifact",
      "Public feature checkpoint 9431cb4 has an exact source gate of 160 modules / 7,473 bodies: 666 directly verified and 6,807 admitted unverified; it retains the canonical Target8B=1 and Draft06B=2 weight-role byte proof and rejected same-source mutation first published at 756e813, integrates the authority-free R33 daemon proof at 3f5b498, and still needs a fresh full release receipt",
      "The aggregate compiler-generated roster and source gate use the exact current descriptor-table order",
      "The typed source-pin adapter admits only the exact aggregate target, code-object version, entry set, and descriptor set; public Ferric feature-branch checkpoint 9431cb4 consumes historical fe2o3 b2cce9c, not current public main 5f46dd2, and final Ferric qualification remains open",
      ...
      "Local source includes a reviewed one-shot protected-verifier listener, but the deployed protected execution profile, concrete checker, signer, supervisor, and production R33 backend are absent, so no deployed protected admission path exists",
      ...
      "R33 V3 event-backed E2E, TTFT, and TPOT comparison support is retained on the public feature branch from a2bb2dc9f0087d4573d58b7c0f5b15aee3b3245b; checkpoint 9431cb4 integrates daemon proof 3f5b498 and the authority-free supervised wire foundation at 66b8547, but no service conformance, runtime authority, Qwen timing, baseline, or comparison follows",
      "The local one-shot listener is not deployed authority; the protected profile, concrete checker, signer, supervisor, and production R33 backend remain absent",
      ...
      "Public fe2o3 5f46dd2 includes generic checked component projection, LLVM 22 Worker compatibility, connected-path Worker V3 V2 transport, and bounded queue waits; local Ferric integration 30af5c2 consumes it and includes listener 64ab4fc, production-wide bounded waits, and authenticated speculative new windows from 3e4f5d6, but is unpublished and has no protected deployment, current aggregate HSACO, target-smoke result, Qwen token, serving or HTTP endpoint, numerical, performance, or baseline result",
    ...
    fe2o3: [
      ...
      "Public origin/main is 5f46dd23cfa3cf58118a93ee2bf5e1252903366c, tree 52ec0a254d626102cbfa37b79a906722490cc9d8; public Ferric feature checkpoint 9431cb4 still consumes historical b2cce9c and is not on main or final",
      "Checked DisjointBlockComponentIndex projection is public at b4f600ae92288ccf1662ddff40d71fefba631777 and LLVM 22 Worker compatibility is public at ce44dc0342003d6325e18f0a83eb27a61601282c; Ferric has not published a current aggregate rerun",
      "Exact connected-path Worker V3 V2 transport is public at 1167b9cfeb28d36ede1ca5ad5f2a71cb5a8719ee, and bounded service/authenticated queue waits are public at 5f46dd23cfa3cf58118a93ee2bf5e1252903366c",
      "fe2o3 owns reusable compiler, runtime, KFD, and generic verification transport work only; Ferric owns model kernels, inference, and Ferric-specific policy",
      ...
      "Local Ferric integration 30af5c2 consumes current fe2o3 main but is not public; Ferric still has no published production aggregate, accepted production artifact/source pin, production R33 backend, or authenticated full-Qwen result",
