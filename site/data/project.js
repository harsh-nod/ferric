window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Seven-case numerical comparison tooling is integrated and host-validated; actual GPU comparisons remain 1 of 7. Private draft KV catch-up is integrated and host-tested, with repeated resident rounds and a new matrix-kernel candidate progressing through separate gates. Latest compiler 0fe passes host suites and emits the 12-kernel image; that image is not GPU-tested. The retained numerical rows are not byte-identical and no tolerance is accepted. All 33 M1 gates remain open; no new serving or performance result is claimed.",
    integration: Object.freeze({
      hostProgress: Object.freeze({
        ...
        resident: Object.freeze({
          ...
          adapterPassed: 12,
          finalAdapterValidated: false,
          nativeRepeatedRounds: false,
          authority: "none",
          detail: "Repeated resident rounds are implemented in a private candidate. Exact 0536 passes the full engine package: 706 library tests (nine existing ignores), binary and doc suites, and strict all-target Clippy. The earlier dd0 adapter passes 12 tests. Final adapter validation remains pending: the corrected 942 retry reached the unchanged workspace cap before tests; its earlier test-only import failure is retained separately. No native repeated-round or catch-up result, serving readiness or qualification follows from these host checks.",
        }),
        mfma: Object.freeze({
          source: "8b74ce4338c99df7b592cddbb684c193c68e45da",
          hostLibraryPassed: 81,
          strictClippyPassed: true,
          deviceCompiled: false,
          gpuTested: false,
          performanceMeasured: false,
          authority: "none",
          detail: "The Ferric MFMA matrix-kernel and catalog candidate at 8b74 passes all 81 host library tests and strict library/test Clippy. It remains a private candidate: no device compilation, GPU execution or performance improvement has been demonstrated. The compiler capability and kernel stay separate from the emitted 4f6 image below.",
        }),
