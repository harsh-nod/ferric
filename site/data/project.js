window.FERRIC_PROJECT = Object.freeze({
  ...
  liveC1Checkpoint: {
    ...
    correctness: "Both arms match every immutable prompt/output token ID and all 793 decoded UTF8 bytes, with exact SSE controller/request associations and slot 0 generations 1 then 2. Each closes normally without cleanup signals after 270 batches and 166,278 dispatches. All eight GPUs are idle before and after; no broader concurrency, sustained serving or default-policy qualification is claimed.",
    ...
    v14: {
      ...
      detail: "Query-hoist v14 passes 13 source-fresh host methods and strict Clippy with actual exit zero. Ten synthetic control tests pass separately using fabricated metadata, not an emitted V14 image. Actual typed emission, query-load placement, native parity and performance remain pending. Neither this candidate nor v13 changes the measured C1 live route.",
    },
  },
  c1Checkpoint: {
