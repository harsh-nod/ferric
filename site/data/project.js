window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    date: "2026-09-14",
    scope: "Private authenticated resident serving; host and compiler progress only",
    implementationPrivate: true,
    m1OpenGates: 33,
    nativeServingQualified: false,
    fullAcceptanceCatchupImplemented: true,
    newGpuMeasurement: false,
    newPerformanceMeasurement: false,
    overview: "Private authenticated S1 K4/K8/K16 draft KV catch-up is integrated and host-tested. The canonical 12-root gfx942 engineering aggregate now emits and replays exactly with published fe2o3 c6b4050; native hardware qualification remains pending. All 33 M1 gates remain open; this checkpoint adds no GPU or performance result.",
    integration: Object.freeze({
      compiler: Object.freeze({
        source: "c6b4050dd6c18e1868b24e4580da3eed8a3d19fa",
        ferricSource: "f17efe83d37105c0da78ea2c8bbbe166a0ee4f43",
        backendPassed: 543,
        kernelHostPassed: 37,
        ...
        manifestSha256: "ff3dfe2c8b75996b52d69c041197ce12ba8f6fde94d31d6f8d8c53be4c6b691d",
        exactOutputReplay: true,
        authority: "none",
        grants: Object.freeze({ publication: false, load: false, launch: false }),
        evidenceSha256: "943179eb018d6d646ea4c5f00609ec5a7b7bc864d9589c7a89e99e2e52dfebea",
        inspectionSha256: "08374b532865bef45fd0543e826bea4a5848a701b34782180c4b346edbc4f74d",
        detail: "fe2o3 c6b4050 is published on main after fresh-fetch review and rebase, with 543 backend tests passing. Exact private Ferric f17efe8 passes 37 aggregate host tests. Pristine release compiler tools produce the canonical gfx942:xnack- code-object V6 engineering image with exact output replay. Independent ELF inspection confirms all 12 kernel entries and 12 matching descriptors; the HSACO is 103,872 bytes. This checks structural symbol sets, not Ferric policy descriptor-table order or numerical execution. Publication, load and launch grants all remain false; engineering authority is none. No native GPU, model-parity, serving or performance result follows.",
    ...
    remaining: "Next: qualify the canonical gfx942 target/draft bundle and exercise the integrated resident catch-up path on hardware. Current-pin engine and checker host validation remain pending; earlier host cohorts are not relabeled as c6b4050 results. No native K8/K16 qualification, new TTFT/TPOT/throughput measurement or competitiveness claim is admitted here. Historical measurements below are unchanged.",
  }),
