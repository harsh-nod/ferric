window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    fullAcceptanceCatchupImplemented: false,
    newGpuMeasurement: false,
    newPerformanceMeasurement: false,
    overview: "Private authenticated serving selects S1 K4, K8 or K16. Draft KV catch-up components are implemented locally, but resident dispatch is still under integration and continuing full acceptance remains fail-closed. All 33 M1 gates remain open; this checkpoint adds no GPU or performance result.",
    ...
    remaining: "Next: resolve the attributed overflow proof obligation without bypassing it, finish authenticated resident draft KV catch-up and combined host validation, then qualify the canonical gfx942 target/draft bundle end to end. No native K8/K16 qualification, new TTFT/TPOT/throughput measurement or competitiveness claim is admitted here. Historical measurements below are unchanged.",
  }),
