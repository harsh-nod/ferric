...
const requiredClaims = [
  ...
  "Current compiler and catch-up checkpoint",
  "539 backend tests passing",
  "semantic bb97, source fingerprint 01a6c27889e4, line 373",
  "rejects the paged committed_tokens + query_token arithmetic-overflow proof obligation",
  "same-source, same-native-MIR comparison stops at a prefill assertion with 829 and this paged assertion with 852",
  ...
  "Source coverage and dependency checks",
