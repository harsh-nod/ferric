...
const requiredClaims = [
  ...
  "profile-extent guards in the RoPE and paged-KV kernels",
  "rope-wrapper 22/22",
  "aggregate 21/21",
  "green remote KFD 295, compiler 489",
  "debug-protocol, closure 12, and worker evidence",
  "exact current-compiler attempt",
  "pre-guard Ferric 362b275",
  "rope_kv.rs lines 212 and 213",
  "rope_kv.rs:143",
  "rows * query_columns",
  "zero connects",
  "zero outputs",
  ...
  "comparison not run",
  "No aggregate HSACO, current Qwen token, hardware result, or vLLM/SGLang benchmark exists",
