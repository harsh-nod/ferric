...
const requiredClaims = [
  ...
  "reusable upstream correction is in progress and not public",
  "Worker V3 HSACO",
  "protected execution profile",
  "protected service socket",
  "159 modules / 7,429 executable bodies",
  "Target8B=1 and Draft06B=2",
  "same-source mutation",
  "scheduler-authority",
  "predecessor restore",
  "lower physical model/KV rebind",
  "retryable RolloverUnavailable",
  "daemon/wire foundation is in progress and not public",
  "CURRENT=None",
