...
const requiredClaims = [
  ...
  "failing closed on one unsupported lint-only attribute",
  "6,951 discovered",
  "6,854 admitted",
  "97 unadmitted",
  "0 stale",
  ...
  "46 service tests",
  "88 adapter tests",
  "75 qualification tests",
  "3 intentional ignores",
  "strict Clippy",
  "focused v20 is fully green",
  "exact v20 produced no HSACO",
  "v21's single-SSA-local fix is active",
  "external proof-shape edits were preserved",
  "Kernel implementation remains in progress",
  "protected one-shot verifier listener",
  "production-wide bounded queue waits",
  "private move-only whole-page-set token",
  "predecessor physical history inertly",
  "resetting active history",
  "Published->Observed->Released",
  "token, history, and API source reviews returned GO",
  "production R33 backend",
