...
const requiredClaims = [
  ...
  "162 modules and 7,533 executable bodies",
  "565 engine tests passed",
  "82 adapter tests",
  "32 service tests",
  "3 intentional ignores",
  "both Clippy gates PASS",
  "exact aggregate compile",
  "reaches Ferric prefill overflow-proof work",
  "Kernel implementation remains in progress",
  "connected-path deployment",
