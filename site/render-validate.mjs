...
const requiredClaims = [
  ...
  "3f5b498",
  "66b8547",
  "origin/codex/fe2o3-current-main-repin-v1",
  "not on main or final",
  "047ee32",
  ...
  "545-packet target batch",
  "physical KV partitioning",
  ...
  "c72c2a8",
  "720c9bc",
  "local, unpublished, non-final",
  "policy v5 terminal status 0",
  "all quality gates passed over 656 files",
  ...
  "does not qualify a future combined tree or latest public fe2o3 5f46dd2",
  "closes no M1 gate",
  "5/5 Rust arithmetic tests",
  "1 function / 33 details / 0 errors",
  "three rejected hostile formula mutations",
  "162 modules / 7,526 bodies",
  "runtime variable-cardinality wiring",
  "transition atomicity",
  "Historical local aggregate reruns using public fe2o3 source",
  "not a published Ferric result",
  "No exact current 5f46dd2 aggregate rerun or HSACO",
  "public inside checkpoint 9431cb4",
  "Worker V3 HSACO",
  "protected execution profile",
  "protected service socket",
  "160 modules and 7,473 executable bodies",
  "666 directly verified",
  "6,807 admitted unverified",
  "exactly 20 ordered measures",
  "four exact positive rows",
  "two hostile actual-body mutations",
  "out-of-order measure",
  "abandoned response incorrectly advancing",
  "no service-conformance claim",
  "Target8B=1 and Draft06B=2",
  "same-source mutation",
  "healthy all-terminal queue shutdown",
  "lower physical model/KV rebind",
  "combined release receipt",
  "CURRENT=None",
  "not a continuous-serving or HTTP endpoint",
  "No Ferric Qwen timing and no vLLM/SGLang baseline result exist",
  "no current aggregate Worker V3 HSACO, Qwen token, measured TTFT or TPOT, serving or HTTP endpoint",
