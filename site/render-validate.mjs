...
const requiredClaims = [
  ...
  "v38",
  "v39",
  "30 pure profile-classifier equalities",
  ...
  "focused and address-equivalence matrix is green 27/27",
  "Clean DCO source",
  "54-file repin",
  "TCB gates are also green 28/28",
  "Pinned-nightly vendor v7 clears sysroot closure",
  "Exact v9 rejected function 6 local 48/type 63",
  "exact v10 rejected local 201/type 63",
  "status 1 and no outputs",
  "focused v44 27/27",
  "sole focused v45 failure was a source-contract substring false positive",
  "component+=1 matched inside row_component+=1",
  "corrected focused v46 27/27",
  "Exact v11 cleared the retained-borrow class",
  "uniform induction bound is not an exact total unsigned index expression",
  "Canonical-bound DCO",
  "format-only DCO",
  "cargo fmt and focused v50 27/27",
  "Exact v13 still rejects the kv_elements/64 bound",
  "status 1 and no output or HSACO",
  "smoke binary",
