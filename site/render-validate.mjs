...
const requiredClaims = [
  ...
  "8693231611bf:239:20",
  "row * vocabulary overflow proof",
  "zero connect, handoff, worker, or current engineering HSACO events",
  "Run 11 emitted a V5 parent of 5,438 bytes",
  "29 children containing 19 bodies",
  ...
  "CURRENT=None",
  "All GPUs are currently occupied",
  "baseline container access remains unresolved",
  "comparison not run",
