...
const requiredClaims = [
  ...
  "Latest four-token native target observation",
  ...
  "Current host validation and engineering binaries",
  ...
  "Current scoped source coverage",
  ...
  "Current-pin engine and checker host validation pass",
