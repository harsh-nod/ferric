...
const requiredClaims = [
  ...
  "Wave RMSNorm v15: static image checks",
  "23 tests + image emitted",
  "seven contract and sixteen host-model tests",
    ...
    if (screenshotRoot) {
      if (name === "desktop" || name === "mobile") {
        ...
        for (const [heading, suffix] of [["Attention attribution and validation", "attention-attribution"],
          ...
          ["Wave RMSNorm v15: static image checks", "v15-emission"],
