...
const requiredClaims = [
  ...
  "Wave RMSNorm v15: finite native checks",
  ...
  "c9c7036cf98034b638886f54a745701e70ac3571; V15 validated; adapter/model pending",
  "9dfedb5d1f9b80bc3f80a859e8740a69b9e5d793; source only; adapter gate, model parity and performance pending",
    ...
    if (screenshotRoot) {
      if (name === "desktop" || name === "mobile") {
        ...
        for (const [heading, suffix] of [["Attention attribution and validation", "attention-attribution"],
          ...
          ["Wave RMSNorm v15: finite native checks", "v15-native"],
