...
const requiredClaims = [
  ...
  "draft KV catch-up is integrated and host-tested",
  "All 33 M1 gates remain open; no new serving or performance result is claimed",
  ...
  "Exact 0536 passes the full engine package: 706 library tests (nine existing ignores)",
  "earlier dd0 adapter passes 12 tests",
  "Final adapter validation remains pending",
  "corrected 942 retry reached the unchanged workspace cap before tests",
  "earlier test-only import failure is retained separately",
  "No native repeated-round or catch-up result",
  "Matrix-kernel candidate: host tests only",
  "candidate at 8b74 passes all 81 host library tests",
  "no device compilation, GPU execution or performance improvement has been demonstrated",
  "Latest compiler image: emitted, not GPU-tested",
  ...
  "Retained 4f6 emission: no GPU validation",
  "HSACO is 103,616 bytes and differs from ccfd despite unchanged aggregate kernel bodies",
  "This retained image has not been GPU or numerically tested",
