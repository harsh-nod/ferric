...
const requiredClaims = [
  ...
  "launcher",
  "distinct-UID",
  "latest-fe2 qualification is not claimed",
  "58 service tests",
  "3 ignores",
  "88 adapter tests",
  "f18ffe2",
  ...
  "test bypasses it",
  "faulted Active+Resident",
  "budgets above 128",
  "fixed 128-token buffer",
  "textual hostile mutations",
  "26m41s",
  "failed closed at the semantic join",
  "physical completion and readback",
  "status 134",
  "Typed custody was retained",
  "VRAM released",
  "exact error branch is unknown",
  "observability fix",
  "same-case rerun",
  "Approximately 24 minutes",
  "cold-start HBM defect",
  "20 inputs",
