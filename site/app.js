(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    ...
    element("h3", "", "Current source coverage: no proof upgrades"),
    ...
    element("h3", "", "Compiler candidate: paired exports, no image yet"),
    element("p", "", resident.integration.hostProgress.compilerCandidate.detail),
    element("h3", "", "Latest compiler image: emitted, not GPU-tested"),
  ...
  for (const [label, value] of [
    ["Current source coverage", resident.integration.sourceCoverage.source],
    ["Current source coverage evidence SHA-256", resident.integration.sourceCoverage.evidenceSha256],
    ...
    ["Latest emitted compiler pin", resident.integration.hostProgress.compiler.source],
    ["Latest emitted aggregate snapshot", resident.integration.hostProgress.compiler.ferricSource],
    ["Latest engineering HSACO SHA-256", resident.integration.hostProgress.compiler.imageSha256],
    ["Latest engineering manifest SHA-256", resident.integration.hostProgress.compiler.manifestSha256],
    ["Latest compiler evidence SHA-256", resident.integration.hostProgress.compiler.evidenceSha256],
    ["Latest ELF inspection SHA-256", resident.integration.hostProgress.compiler.inspectionSha256],
