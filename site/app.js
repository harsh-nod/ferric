(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    element("h3", "", "Latest four-token native target observation"),
    ...
    element("h3", "", "Current host validation and engineering binaries"),
    ...
    element("h3", "", "Current scoped source coverage"),
  ...
  for (const [label, value] of [
    ...
    ["Exact private aggregate snapshot", resident.integration.compiler.ferricSource],
    ["Engineering HSACO SHA-256", resident.integration.compiler.imageSha256],
    ["Engineering manifest SHA-256", resident.integration.compiler.manifestSha256],
    ...
    ["Current host snapshot", resident.integration.currentHost.source],
    ["Current host evidence SHA-256", resident.integration.currentHost.evidenceSha256],
    ["Current release binaries evidence SHA-256", resident.integration.currentHost.releaseEvidenceSha256],
    ["Current scoped coverage source", resident.integration.currentCoverage.source],
    ["Current scoped coverage evidence SHA-256", resident.integration.currentCoverage.evidenceSha256],
