(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    ...
    element("h3", "", "Latest compiler emission: no GPU validation"),
  ...
  for (const [label, value] of [
    ["Latest tested compiler pin", resident.integration.latestCompiler.source],
    ["Latest exact aggregate snapshot", resident.integration.latestCompiler.ferricSource],
    ["Latest engineering HSACO SHA-256", resident.integration.latestCompiler.imageSha256],
    ["Latest engineering manifest SHA-256", resident.integration.latestCompiler.manifestSha256],
    ["Latest compiler evidence SHA-256", resident.integration.latestCompiler.evidenceSha256],
    ["Latest ELF inspection SHA-256", resident.integration.latestCompiler.inspectionSha256],
