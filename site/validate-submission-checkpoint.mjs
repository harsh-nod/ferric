...
const liveHttpExpected = {
    ...
    teams: [
      ...
      { name: "Visible-token attention", source: "4e287b1ed0058cca95908b0a977748d9ef8b56ee",
        tree: "c5c5a59c35a55b2a997937e73b8ce50ae05cd4f7", state: "host-complete-emission-and-native-pending",
        detail: "Host custody is admitted: 24 ordinary successful steps and two exact known-debt checks, 64 test invocations and ten retained executables. The two actual strict Clippy commands exited 101 and matched known debt, not a strict Clippy pass. Emission and native correctness remain pending; no gain is claimed." },
      { name: "Cooperative KV append", source: "d03ccd5436fe99d9dc7f761964b0fd978db3cd0f",
        tree: "8543635ba23ac1f8ee7c8220d253af6cf50e405a", state: "host-gate-in-progress-emission-pending",
        ...
        detail: "Candidate 2716371 is rejected by the emission resource gate: 278 SGPR spills versus zero in its baseline. The smaller active-block loop is reviewed and remotely formatted at d03ccd5; its host gate is in progress, with a new emission gate and native correctness still pending. No candidate GPU launch or performance gain is admitted." },
    ],
