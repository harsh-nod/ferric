...
const liveHttpExpected = {
    ...
    teams: [
      ...
      { name: "Ordered residual tail", source: "2396a82ff42c94654261a2ee8313f881a77aee1d",
        tree: "b9c74a4fda441f0df381d7f1e04525ddcd7a5da4", state: "host-archive-admitted", label: "CPU gate accepted",
        ...
        strictClippyExit: 0, archiveAdmitted: true, nativeAdmitted: false, performanceGainClaimed: false,
        detail: "All 31 CPU commands passed: 780 adapter test invocations, 41 ignored across 19 result rows, 8 doctests, 74 HTTP fixtures, 38 source-gate and 31 protected-policy tests. Strict Clippy exited zero and source custody remained unchanged. The complete archive is accepted; private integration 212ec85 preserves the tested code. Native correctness and performance are not yet admitted; no GPU gain or default change is claimed." },
    ],
