...
REVISION = "f7f5aa32600959a56a80d34fd608bcf935bc09cf"
...
[dependencies]
fe2o3-device = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "f7f5aa32600959a56a80d34fd608bcf935bc09cf", version = "=0.1.0" }
...
name = "pliron"
version = "0.17.0"
source = "git+https://github.com/harsh-nod/pliron.git?rev=cc902cc8c669b5de2b292ae8638d9e8311bc735b#cc902cc8c669b5de2b292ae8638d9e8311bc735b"
''',
        encoding="ascii",
    )
...
def main() -> None:
    ...
    for required in [
        'FE2O3_REVISION = "f7f5aa32600959a56a80d34fd608bcf935bc09cf"',
