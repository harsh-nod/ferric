...
REVISION = "18946f627ac183958535ca858207fa856bd49aa5"
...
[dependencies]
fe2o3-device = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "18946f627ac183958535ca858207fa856bd49aa5", version = "=0.1.0" }
...
name = "pliron"
version = "0.17.0"
source = "git+https://github.com/harsh-nod/pliron.git?rev=9de42fc6ca7b8f3500ccf2346d69ebbb36e889cd#9de42fc6ca7b8f3500ccf2346d69ebbb36e889cd"
''',
        encoding="ascii",
    )
...
def main() -> None:
    ...
    for required in [
        'FE2O3_REVISION = "18946f627ac183958535ca858207fa856bd49aa5"',
