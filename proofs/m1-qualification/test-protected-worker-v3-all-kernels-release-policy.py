...
REVISION = "be5668eaa71f8d60a0a5041891d25ce2ed9c2e6e"
...
[dependencies]
fe2o3-device = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "be5668eaa71f8d60a0a5041891d25ce2ed9c2e6e", version = "=0.1.0" }
...
def main() -> None:
    ...
    for required in [
        'FE2O3_REVISION = "be5668eaa71f8d60a0a5041891d25ce2ed9c2e6e"',
