...
REVISION = "85255498a021ed2b7a1a511f99f577ee4b11d175"
...
[dependencies]
fe2o3-device = { git = "https://github.com/harsh-nod/fe2o3.git", rev = "85255498a021ed2b7a1a511f99f577ee4b11d175", version = "=0.1.0" }
...
def main() -> None:
    ...
    for required in [
        'FE2O3_REVISION = "85255498a021ed2b7a1a511f99f577ee4b11d175"',
