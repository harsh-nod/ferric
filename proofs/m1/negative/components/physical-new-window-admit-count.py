#!/usr/bin/env python3
"""Compute fresh admissions from the predecessor cardinality."""
...
old = "    let admit_count = match new_count.checked_sub(reuse_count) {\n"
new = "    let admit_count = match old_count.checked_sub(reuse_count) {\n"
...
if tail.count(old) != 1:
    raise SystemExit("physical new-window admit-count mutation anchor drifted")
...
print("MUTATION=physical-new-window-admit-count")
print("CLAUSE=admit-successor-difference")
