...
EXPECTED = {
    ...
    "kernel-memory-read-initialization": (
        "modeled-kernel-safety-certificate", "memory_safe",
        "kernel-contract-proof", "ferric-kernels",
        "crates/ferric-kernels/src/m1_kernel_safety.rs",
        "kernel-memory-read-initialization.py", "postcondition",
        "m1_kernel_safety", "validate_m1_kernel_memory_safety",
        "initialized-read-range-coverage",
    ),
    "kernel-race-conflict": (
        "modeled-kernel-safety-certificate", "race_free",
        "kernel-contract-proof", "ferric-kernels",
        "crates/ferric-kernels/src/m1_kernel_safety.rs",
        "kernel-race-conflict.py", "postcondition",
        "m1_kernel_safety", "validate_m1_kernel_race_freedom",
        "same-phase-conflict-rejection",
    ),
    "kernel-resource-workitem-bound": (
        "modeled-kernel-safety-certificate", "resource_bounded",
        "kernel-schedule-catalog", "ferric-kernels",
        "crates/ferric-kernels/src/m1_kernel_safety.rs",
        "kernel-resource-workitem-bound.py", "postcondition",
        "m1_kernel_safety", "validate_m1_kernel_resource_bounds",
        "finite-workitem-schedule-bound",
    ),
    ...
    "physical-new-window-predecessor-set": (
        ...
        "physical-new-window-predecessor-set.py", "postcondition",
        "physical_new_window", "check_m1_physical_new_window_precommit_v1",
        "current-historical-predecessor-set",
    ),
    "physical-new-window-retry-quarantine": (
        "physical-new-window-commit-custody", "scheduler_refined",
        "physical-runner", "ferric-m1-proof",
        "proofs/m1/physical_new_window.rs",
    ...
    "physical-new-window-terminal-quarantine": (
        ...
        "physical-runner", "ferric-m1-proof",
        "proofs/m1/physical_new_window.rs",
        "physical-new-window-terminal-quarantine.py", "postcondition",
        "physical_new_window", "execute_m1_physical_new_window_transaction_v1",
        "postcommit-failure-quarantined",
    ),
    ...
    "r33-daemon-measure-order": (
        "r33-daemon-lifecycle", "resource_bounded", "serving-bench",
        "ferric-m1-proof", "proofs/m1/r33_daemon_lifecycle.rs",
        "r33-daemon-measure-order.py", "postcondition",
        "r33_daemon_lifecycle", "dispatch_m1_r33_daemon_action_v1",
        "exact-next-measure-window",
    ),
    "r33-daemon-response-abandonment": (
        "r33-daemon-lifecycle", "resource_bounded", "serving-bench",
        "ferric-m1-proof", "proofs/m1/r33_daemon_lifecycle.rs",
        "r33-daemon-response-abandonment.py", "postcondition",
        "r33_daemon_lifecycle", "resolve_m1_r33_daemon_response_v1",
