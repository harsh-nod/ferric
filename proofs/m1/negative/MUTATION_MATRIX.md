...
| `physical-new-window-reclaim-count` | `m1_new_window_cardinality::plan_m1_new_window_cardinality_v1` | reclaimed predecessors equal the predecessor cardinality minus reused slots | `scheduler_refined` / `physical-runner` |
...
| `physical-new-window-reuse-count` | `m1_new_window_cardinality::plan_m1_new_window_cardinality_v1` | reincarnated slots equal the smaller predecessor or successor cardinality | `scheduler_refined` / `physical-runner` |
