(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    ...
    element("p", "", resident.integration.mi350ModelTransport.detail),
    element("h3", "", "mi350: passive loader checks passed"),
    element("p", "", resident.integration.mi350PassiveLoader.detail),
    element("h3", "", "Compiler fe406: four-tool custody complete"),
    element("p", "", resident.integration.compilerToolsFe406.detail),
    element("h3", "", "TP14 prerequisites: source-gate and metadata passed"),
    element("p", "", resident.integration.tp14SourceGateFe406.detail),
    element("p", "performance-scope", "The earlier Asrock identity and TP1 portability checkpoints retain their original host and source attribution."),
    element("h3", "", "TP1 controller: CPU checks and static portability passed"),
    element("p", "", resident.integration.tp1PortableController.detail),
    element("h3", "", "Compiler fe406: dependency adoption validated"),
    element("p", "", resident.integration.compilerAdoptionFe406.detail),
    element("h3", "", "Asrock runtime: published with fresh CPU and ABI checks"),
    element("p", "", resident.integration.asrockRuntimePublished.detail),
    element("h3", "", "mi350-2: checked identity bind, no kernel dispatch"),
    element("p", "", resident.integration.mi350CheckedBinding.detail),
    element("h3", "", "Earlier compiler 998: dependency adoption validated"),
    element("p", "", resident.integration.compilerAdoption998.detail),
    element("h3", "", "Final-RMS R3: timeout after KFD binding"),
    element("p", "", resident.integration.native9b64Timeout.detail),
    element("h3", "", "BF16 observer wrapper: verified and integrated"),
    element("p", "", resident.integration.bf16WrapperCandidate.detail),
    element("h3", "", "Earlier compiler 9b64: 13-kernel emission passed"),
    element("p", "", resident.integration.compiler9b64Emission.detail),
    element("h3", "", "Earlier final-RMS R1/R2: two guarded aborts"),
    element("p", "", resident.integration.native9b64GuardedAttempts.detail),
    element("h3", "", "Earlier mi350-2 survey: platform compatibility required"),
    element("p", "", resident.integration.mi350PlatformCompatibility.detail),
    element("p", "performance-scope", "The retained checkpoints below preserve their original source identities and then-pending states. The wrapper's integration does not relabel earlier host, native or performance results."),
    ...
    element("h3", "", "Earlier compiler f7f checkpoint"),
    element("p", "", resident.integration.compilerAndMi350Readiness.detail),
  ...
  for (const [label, value] of [
    ["mi350 eight-device identity source", resident.integration.mi350EightCheckedBinding.source],
    ["mi350 identity ELF SHA-256", resident.integration.mi350EightCheckedBinding.identityElfSha256],
    ["mi350 original profile SHA-256", resident.integration.mi350EightCheckedBinding.selectedProfileSha256],
    ["mi350 eight-device identity evidence SHA-256", resident.integration.mi350EightCheckedBinding.evidenceSha256],
    ["mi350 identity payload ledger SHA-256", resident.integration.mi350EightCheckedBinding.payloadLedgerSha256],
    ["mi350 model source transfer evidence SHA-256", resident.integration.mi350ModelTransport.sourceEvidenceSha256],
    ["mi350 model destination transfer evidence SHA-256", resident.integration.mi350ModelTransport.destinationEvidenceSha256],
    ["mi350 model coordinator evidence SHA-256", resident.integration.mi350ModelTransport.coordinatorEvidenceSha256],
    ["mi350 passive loader evidence SHA-256", resident.integration.mi350PassiveLoader.evidenceSha256],
    ["Compiler fe406 tool evidence SHA-256", resident.integration.compilerToolsFe406.evidenceSha256],
    ["TP14 source-gate evidence SHA-256", resident.integration.tp14SourceGateFe406.evidenceSha256],
    ["TP1 roster and controller source", resident.integration.tp1PortableController.source],
    ["TP1 roster and controller tree", resident.integration.tp1PortableController.sourceTree],
    ["TP1 original controller SHA-256", resident.integration.tp1PortableController.originalControllerSha256],
    ["TP1 fixed-source controller SHA-256", resident.integration.tp1PortableController.fixedControllerSha256],
    ["TP1 portable controller SHA-256", resident.integration.tp1PortableController.portableControllerSha256],
    ["TP1 private link-input archive SHA-256", resident.integration.tp1PortableController.capturedLinkInputsSha256],
    ["TP1 build and portability evidence SHA-256", resident.integration.tp1PortableController.evidenceSha256],
    ["BF16 wrapper proof/test source", resident.integration.bf16WrapperCandidate.source],
    ["BF16 wrapper proof/test tree", resident.integration.bf16WrapperCandidate.sourceTree],
    ["BF16 wrapper integration source", resident.integration.bf16WrapperCandidate.integrationSource],
    ["BF16 wrapper integration tree", resident.integration.bf16WrapperCandidate.integrationTree],
    ["BF16 wrapper validation archive SHA-256", resident.integration.bf16WrapperCandidate.validationArchiveSha256],
    ["BF16 wrapper positive transcript SHA-256", resident.integration.bf16WrapperCandidate.positiveTranscriptSha256],
    ["Published Asrock runtime source", resident.integration.asrockRuntimePublished.source],
    ["Published Asrock runtime tree", resident.integration.asrockRuntimePublished.sourceTree],
    ["Asrock CPU and ABI evidence SHA-256", resident.integration.asrockRuntimePublished.evidenceSha256],
    ["mi350-2 identity observation source", resident.integration.mi350CheckedBinding.source],
    ["mi350-2 identity ELF SHA-256", resident.integration.mi350CheckedBinding.identityElfSha256],
    ["mi350-2 selected profile SHA-256", resident.integration.mi350CheckedBinding.selectedProfileSha256],
    ["mi350-2 identity evidence SHA-256", resident.integration.mi350CheckedBinding.evidenceSha256],
    ["Current integrated compiler", resident.integration.compilerAdoptionFe406.compilerSource],
    ["Compiler fe406 adoption source", resident.integration.compilerAdoptionFe406.source],
    ["Compiler fe406 adoption tree", resident.integration.compilerAdoptionFe406.sourceTree],
    ["Compiler fe406 final source census SHA-256", resident.integration.compilerAdoptionFe406.finalSourceCensusSha256],
    ["Compiler fe406 adoption evidence SHA-256", resident.integration.compilerAdoptionFe406.evidenceSha256],
    ["Compiler 998 adoption source", resident.integration.compilerAdoption998.source],
    ["Compiler 998 adoption tree", resident.integration.compilerAdoption998.sourceTree],
    ["Compiler 998 adoption evidence SHA-256", resident.integration.compilerAdoption998.evidenceSha256],
    ["Native R3 timeout source", resident.integration.native9b64Timeout.source],
    ["Native R3 timeout evidence SHA-256", resident.integration.native9b64Timeout.evidenceSha256],
    ["Matching 9b64 emission source", resident.integration.compiler9b64Emission.source],
    ["Matching 9b64 HSACO SHA-256", resident.integration.compiler9b64Emission.hsacoSha256],
    ["Matching 9b64 emission evidence SHA-256", resident.integration.compiler9b64Emission.evidenceSha256],
    ["Guarded native R1 failure evidence SHA-256", resident.integration.native9b64GuardedAttempts.r1EvidenceSha256],
    ["Guarded native R2 failure evidence SHA-256", resident.integration.native9b64GuardedAttempts.r2EvidenceSha256],
    ...
    ["Earlier integrated compiler (f7f)", resident.integration.compilerAndMi350Readiness.integratedCompiler],
    ...
    ["Earlier source-only compiler observation", resident.integration.compilerAndMi350Readiness.newerObservedCompiler],
    ["Earlier abd8 emission tracker source", resident.integration.emissionAbd8.trackerSource],
    ...
    ["Retained bd1 dependency pin", resident.integration.upstreamAndNativeHold.integratedCompiler],
    ...
    ["Earlier compiler 9f8 adoption source", resident.integration.compilerAdoption9f8.adoptedSource],
    ["Earlier adopted compiler (9f8)", resident.integration.compilerAdoption9f8.compilerSource],
