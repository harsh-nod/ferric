(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    element("h3", "", "Current runtime: tested diagnostics, maintenance still blocked"),
  ...
  for (const [label, value] of [
    ...
    ["Unpublished compiler successor", resident.integration.compilerFollowup.successorSource],
