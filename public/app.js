(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    element("h3", "", "Dependency refresh passed; caller validation pending"),
  ...
  for (const [label, value] of [
    ["Current private integration source", resident.integration.dependencyRefresh.source],
    ["Current private integration tree", resident.integration.dependencyRefresh.tree],
    ["Current integration compiler dependency", resident.integration.dependencyRefresh.compilerSource],
    ...
    ["Unvalidated contracted caller source", resident.integration.dependencyRefresh.callerSource],
    ...
    ["Published compiler source", resident.integration.compilerFollowup.currentSource],
    ["Current compiler observed upstream", resident.integration.compilerFollowup.newerObservedUpstreamSource],
    ["Current compiler R12 host evidence SHA-256", resident.integration.compilerFollowup.currentHostEvidenceSha256],
