(function renderFerricStatus() {
  ...
  residentProgress.append(element("p", "performance-scope", resident.scope),
    ...
    element("h3", "", "Compiler f7f adopted; gfx950 prerequisites remain"),
  ...
  for (const [label, value] of [
    ...
    ["Newer source-audited compiler; adoption pending", resident.integration.compilerAndMi350Readiness.newerObservedCompiler],
