window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Ferric now integrates an opt-in thirteen-program MFMA path. The 55-pinned host checkpoint has 1,195 passing tests and 14 ignores across sources 5bcf44ed/f9def4c0, plus 11 scoped passes at 538aa053. R4 core Clippy passes; adapter and kernel lint work remains open. The batch consumer's R4 proof retry reaches SMT but still fails. Upstream 179 is fetched, adoption pending. No new GPU or performance result. All 33 M1 gates remain open.",
  ...
  recentProgress: [
    {
      sourceStatus: "947a205",
      title: "Core Clippy passes; adapter/kernel lint work and consumer proof remain open",
      state: "integration",
      detail: "The integrated MFMA strategy stays explicit opt-in with LegacyScalar12 as default. Sources 5bcf44ed/f9def4c0 report 1,195 host passes and 14 ignores in separate campaigns; 538aa053 adds 11 scoped passes. R4 strict core Clippy passes; adapter ordering and aggregate kernel style diagnostics remain open. The adapter-only reorder awaits its lint retry. Seven dependency exports remain verified, but ghost-only fix ea529fd8's actual R4 consumer proof retry reaches SMT and fails final-prefix and next-prefix obligations at the unchanged solver limit. Newly fetched compiler 179340e3 is not adopted or validated. No new GPU or performance result and no M1 gate closure.",
    },
    {
