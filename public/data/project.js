window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    remaining: "Next: review numerical acceptance and investigate the remaining logit differences, then build the current seven-case capture executable, run the remaining R29 GPU cases, finish resident validation and exercise repeated rounds on hardware. Latest combined host validation is separate from the retained bb2/ccfd cohorts below. The selected logit comparison accepts no tolerance; neither target-only observation qualifies resident speculative serving. No native K8/K16 qualification, new TTFT/TPOT/throughput measurement or competitiveness claim is admitted here. All 33 M1 gates remain open. Historical measurements below are unchanged.",
  }),
