window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Model-bundle revalidation now checks retained target and draft manifest commitments. Scoped checks pass: 47 source-gate tests, 18 engine regressions, strict Clippy and genuine source-inventory generation. A separate three-module Verus command reports 119 verified queries; its original checker failure and later assessment remain separate. The registered proof attempt times out during dependency compilation, without a selected-theorem result or negative-mutation run. Compiler 7f90d187 remains the validated pin; newer 2d3ffbed is observed but unadopted. No new GPU observation, TTFT, TPOT or throughput measurement. All 33 M1 gates remain open.",
