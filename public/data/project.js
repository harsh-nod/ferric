window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Ferric's compiler-111 engineering run completes 32 tokens and one full-acceptance draft catch-up. A separate prefill comparison matches one token, but logit differences remain unqualified. The production catch-up method has a focused proof, not an engine-wide proof. Compiler 349b2cd0 passes dependency/source checks only; observed upstream 45d0bf2e is not adopted. MFMA13 remains opt-in, with LegacyScalar12 the default. No new TTFT, TPOT, throughput or serving qualification. All 33 M1 gates remain open.",
