window.FERRIC_PROJECT = Object.freeze({
  ...
  residentCheckpoint: Object.freeze({
    ...
    overview: "Frozen Ferric a0cc9929 / compiler 1fadb7e0 now has matching compiler tools, an optimized native executable, MFMA13 emission and a completed five-position M5 capture. The independent reference repeats twice byte-identically and matches all five greedy tokens, with measurable logit differences and no reviewed tolerance. The context uses a historical 128-active-token filled prefix, not normal real-prompt serving. The earlier adoption passes 47 dependency/source-gate phases; those phases alone are not engine, proof or native validation. The combined M5 capture source passes 750 engine tests, 22 smoke tests and three Python suites on earlier compiler 349b2cd0. Its proof verifies one production catch-up method, not the whole engine; nine negative mutations remain attributed to compiler 111. The retained compiler-111 run completes 32 tokens, while its separate prefill comparison remains numerically unqualified. The core compiler correction's original R5 campaign passes 52 selected tests, but strict Clippy exits 101 at 17 unchanged sites. MFMA13 remains opt-in, with LegacyScalar12 the default. No new TTFT, TPOT, throughput or serving qualification. All 33 M1 gates remain open.",
