...
impl M1PhysicalRunnerV1 {
    ...
    /// Revalidates and lends the exact structural physical program catalog for
    ...
    /// Revalidates the structural catalog, binds all physical owners into a fixed
    ...
    /// Revalidates the retained structural program source and submits one prepared same-shape
    ...
    /// Revalidates the retained structural program source and replaces paired prefill with one
