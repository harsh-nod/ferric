...
mod tests {
    ...
    fn generates_every_exact_target_and_draft_bucket_deterministically() {
        ...
        assert_eq!(
            first.1,
            Identity::new([
                0x57, 0xd3, 0x87, 0xca, 0xbd, 0x2c, 0x2c, 0xb8, 0x2f, 0x88, 0x0f, 0x80, 0x3b, 0xf7,
                0x87, 0xbc, 0x8d, 0xe4, 0xdf, 0x8d, 0x4c, 0xf0, 0x15, 0x7a, 0xa9, 0x64, 0x3c, 0x62,
                0x25, 0xda, 0xd3, 0xfa,
            ]),
            "actual catalog identity: {:02x?}",
            first.1.as_bytes(),
        );
