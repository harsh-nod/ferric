...
const GENERATED_VALIDATION_SOURCE_BYTES: u64 = 36_648;
const GENERATED_VALIDATION_SOURCE_SHA256: [u8; 32] = [
    0x20, 0x76, 0x9f, 0xb5, 0x3e, 0xd4, 0xa6, 0x3e, 0x1f, 0xa1, 0xaf, 0x86, 0x43, 0x8a, 0x59, 0x11,
    0xeb, 0xfe, 0xdf, 0xaa, 0x8d, 0x48, 0xf8, 0x3d, 0xa0, 0x19, 0x3e, 0xe3, 0x8b, 0x17, 0xee, 0x98,
];
...
mod tests {
    ...
    fn regeneration_and_complete_source_closure_are_byte_exact() {
        ...
        assert_eq!(
            ...
            Identity::new([
                0x34, 0xf2, 0xb5, 0x8f, 0x49, 0x8e, 0xce, 0xb6, 0x3f, 0x85, 0xf0, 0xbb, 0xd3, 0xa0,
                0xc7, 0x80, 0x31, 0x16, 0x00, 0xbb, 0x51, 0x39, 0x7c, 0xc6, 0x09, 0xe1, 0x1b, 0x6a,
                0xd5, 0x1c, 0x6a, 0x4d,
            ]),
            "actual generated source identity: {:02x?}",
            expected_qwen3_gfx942_runner_source_identity().as_bytes(),
        );
    ...
    fn exact_declaration_retains_all_plans_operations_shapes_and_identities() {
        ...
        assert_eq!(
            ...
            Identity::new([
                0xab, 0x53, 0xf4, 0xd8, 0x4f, 0x8b, 0xb7, 0xe1, 0x39, 0x08, 0xfd, 0x01, 0xdb, 0x37,
                0x5c, 0xa1, 0x05, 0x4b, 0x00, 0xf4, 0x60, 0x01, 0x00, 0x7b, 0xf0, 0xe0, 0xa2, 0x1a,
                0xfd, 0xf3, 0x6a, 0x39,
            ]),
