...
fn main() {
    ...
    .expect("Qwen3 FP32 head target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=f41625e2617ac1c8d13124b8408957631a5e2e60203e692f7ecab140a508ac2a"
    );
}
