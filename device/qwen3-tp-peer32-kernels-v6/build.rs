...
fn main() {
    ...
    .expect("Qwen3 TP peer32 target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=68f122ed98e4e5402f80f8c45553f17b941a0296c0bd47f7bbe8e38a0e351f09"
    );
}
