...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=6492c8fa85a00d93aa6ca2a4a77675fefad2fee6#6492c8fa85a00d93aa6ca2a4a77675fefad2fee6";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=6492c8fa85a00d93aa6ca2a4a77675fefad2fee6#")
            .count(),
        fe2o3_sources.len()
    );
}
