...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=e527d230c05dfeefec6cc6c91de0b6f16310f677#e527d230c05dfeefec6cc6c91de0b6f16310f677";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=e527d230c05dfeefec6cc6c91de0b6f16310f677#")
            .count(),
        fe2o3_sources.len()
    );
}
