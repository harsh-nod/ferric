...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=f85bb375e7d6f4b8193e697293d29a8888439f0b#f85bb375e7d6f4b8193e697293d29a8888439f0b";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=f85bb375e7d6f4b8193e697293d29a8888439f0b#")
            .count(),
        fe2o3_sources.len()
    );
}
