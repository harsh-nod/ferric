...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=c6b4050dd6c18e1868b24e4580da3eed8a3d19fa#c6b4050dd6c18e1868b24e4580da3eed8a3d19fa";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=c6b4050dd6c18e1868b24e4580da3eed8a3d19fa#")
            .count(),
        fe2o3_sources.len()
    );
}
