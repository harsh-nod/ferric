...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=3d10825df93a86644cc5a5b006cadd45f71afb91#3d10825df93a86644cc5a5b006cadd45f71afb91";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=3d10825df93a86644cc5a5b006cadd45f71afb91#")
            .count(),
        fe2o3_sources.len()
    );
}
