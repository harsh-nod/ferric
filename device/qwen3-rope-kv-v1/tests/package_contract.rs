...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=9b64a2da7f81f7ca2649cb44142dbd2f3e268496#9b64a2da7f81f7ca2649cb44142dbd2f3e268496";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=9b64a2da7f81f7ca2649cb44142dbd2f3e268496#")
            .count(),
        fe2o3_sources.len()
    );
}
