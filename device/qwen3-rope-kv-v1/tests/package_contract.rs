...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=2d3ffbedd6dc2dd51d777ede70e26329370bcf77#2d3ffbedd6dc2dd51d777ede70e26329370bcf77";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=2d3ffbedd6dc2dd51d777ede70e26329370bcf77#")
            .count(),
        fe2o3_sources.len()
    );
}
