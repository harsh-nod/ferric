...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=ccfd43d6bc58b27e0efe510b0ee1b8463166dfc2#ccfd43d6bc58b27e0efe510b0ee1b8463166dfc2";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=ccfd43d6bc58b27e0efe510b0ee1b8463166dfc2#")
            .count(),
        fe2o3_sources.len()
    );
}
