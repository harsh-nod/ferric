...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=bd1ed7d559b1a372644a78b1ede7e6057e5ccbc7#bd1ed7d559b1a372644a78b1ede7e6057e5ccbc7";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=bd1ed7d559b1a372644a78b1ede7e6057e5ccbc7#")
            .count(),
        fe2o3_sources.len()
    );
}
