...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=eaa057ac34f8fc3cfda3dd2c2cb7df058560de06#eaa057ac34f8fc3cfda3dd2c2cb7df058560de06";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=eaa057ac34f8fc3cfda3dd2c2cb7df058560de06#")
            .count(),
        fe2o3_sources.len()
    );
}
