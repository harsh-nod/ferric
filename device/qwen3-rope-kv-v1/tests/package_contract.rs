...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=0ea54ed921cbef5fb2171f4ed7a25b9c1c5e2b71#0ea54ed921cbef5fb2171f4ed7a25b9c1c5e2b71";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=0ea54ed921cbef5fb2171f4ed7a25b9c1c5e2b71#")
            .count(),
        fe2o3_sources.len()
    );
}
