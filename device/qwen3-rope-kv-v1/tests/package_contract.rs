...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=9989714525028db2e73bacfaa944f97fd3d5eeff#9989714525028db2e73bacfaa944f97fd3d5eeff";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=9989714525028db2e73bacfaa944f97fd3d5eeff#")
            .count(),
        fe2o3_sources.len()
    );
}
