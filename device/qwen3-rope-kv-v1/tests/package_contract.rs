...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=3546d54d2c4a913f5d079701aed557d0a378bba8#3546d54d2c4a913f5d079701aed557d0a378bba8";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=3546d54d2c4a913f5d079701aed557d0a378bba8#")
            .count(),
        fe2o3_sources.len()
    );
}
