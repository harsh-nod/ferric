...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=6f6a67bb2f6de70a1c5533bbcde1b09449c37359#6f6a67bb2f6de70a1c5533bbcde1b09449c37359";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=6f6a67bb2f6de70a1c5533bbcde1b09449c37359#")
            .count(),
        fe2o3_sources.len()
    );
}
