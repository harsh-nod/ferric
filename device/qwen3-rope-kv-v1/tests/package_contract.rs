...
const FE2O3_LOCK_SOURCE: &str = "git+https://github.com/harsh-nod/fe2o3.git?rev=7abce5c161389e93cd92f9d4748c34f2b21ba7d5#7abce5c161389e93cd92f9d4748c34f2b21ba7d5";
...
fn manifest_and_complete_lock_closure_pin_exact_reviewed_fe2o3_source() {
    ...
    assert_eq!(
        LOCK.matches("?rev=7abce5c161389e93cd92f9d4748c34f2b21ba7d5#")
            .count(),
        fe2o3_sources.len()
    );
}
