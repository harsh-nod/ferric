...
#[kernel(typed, launch(required = [64, 1, 1], max = [64, 1, 1], max_grid = [1536, 1, 1]))]
pub fn ferric_qwen3_draft_batch32_swiglu_bf16_f32_v10(
    gate: &[u16],
    up: &[u16],
