...
fn main() {
    ...
    .expect("Qwen3 query-hoist attention target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=67fbb77667e1abef6fd517f7176c1a0a71efcc92a0eed20f3f7b4a5e2ee3963f"
    );
}
