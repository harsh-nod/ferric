...
compile_error!("the v4 peer profile requires gfx950");
...
-> alloc::vec::Vec<fe2o3_host::CompilerGeneratedKernelExpectationRosterEntryV1> {
    ...
    let mut entries = alloc::vec![
        Entry::for_marker::<collective::ferric_qwen3_tp_peer_ordered_residual_bf16_v4_gpu::Marker>(
        ),
        Entry::for_marker::<collective::ferric_qwen3_tp_peer_copy_bf16_v4_gpu::Marker>(),
    ];
