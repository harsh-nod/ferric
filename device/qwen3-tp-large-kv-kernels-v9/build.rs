...
fn main() {
    ...
    .expect("Qwen3 large-KV target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=7e39f6dbc5dc327cd445fdb8cfde35e95e5bda25495f78b57a66031123ef9b8b"
    );
}
