...
#[cfg(test)]
macro_rules! batch_paged_attention_pair_v9 {
...
#[kernel(typed, launch(required = [64, 1, 1], max = [64, 1, 1], max_grid = [1024, 1, 1]), control_flow(loop_bounds(8192, 128)))]
#[allow(clippy::too_many_arguments)]
pub fn ferric_qwen3_tp_batch32_large_kv_paged_gqa_bf16_f32_v9(
    query: &[u16],
    key_cache: &[u16],
    value_cache: &[u16],
    positions: &[u32],
    ...
    let (first, second) = {
        // BEGIN batch_paged_attention_pair_v9
        let mut maximum = 0.0_f32;
        let mut denominator = 0.0_f32;
        let mut numerator_0 = 0.0_f32;
        let mut numerator_1 = 0.0_f32;
        ...
        (narrowed_0.to_bits(), narrowed_1.to_bits())
        // END batch_paged_attention_pair_v9
    };
