...
#[cfg(test)]
macro_rules! batch_paged_attention_pair_v5 {
...
pub fn ferric_qwen3_tp_batch32_paged_gqa_bf16_f32_v5(
    query: &[u16],
    key_cache: &[u16],
    value_cache: &[u16],
    positions: &[u32],
    ...
    let (first, second) = {
        // BEGIN batch_paged_attention_pair_v5
        let mut maximum = 0.0_f32;
        let mut denominator = 0.0_f32;
        let mut numerator_0 = 0.0_f32;
        let mut numerator_1 = 0.0_f32;
        ...
        (narrowed_0.to_bits(), narrowed_1.to_bits())
        // END batch_paged_attention_pair_v5
    };
