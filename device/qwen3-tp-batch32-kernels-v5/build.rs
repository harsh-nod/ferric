...
fn main() {
    ...
    .expect("Qwen3 TP batch32 target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=4328a291b204d02a6b41fe120dc772199cf90e24ed7c9f4f508c91dc42af7963"
    );
}
