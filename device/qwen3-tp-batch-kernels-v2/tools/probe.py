...
def self_test(core):
    ...
    core.require(len(fixtures) == 11 and len({case["symbol"] for case in fixtures}) == 7, "probe roster")
...
def main():
    ...
    if args.self_test:
        ...
        print("PASS: eleven bounded host fixtures; no GPU worker launched")
        return
    ...
    try:
        ...
        report = {"schema": "FerricTpBatchSyntheticKernelProbeV2", "authority": "none",
        ...
        with (args.output / "result.json").open("x", encoding="utf-8") as output:
            ...
            output.write("\n")
        print("PASS: eleven GPU probes across seven roots; no model/benchmark/qualification claim")
