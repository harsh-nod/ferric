...
fn main() {
    ...
    .expect("Qwen3 TP batch target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=4dcef910ad617f294f9a550f349f09788ddce62ec773ae4d10bd5ae9aba74e21"
    );
}
