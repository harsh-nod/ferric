...
#[kernel(typed, launch(required = [64, 1, 1], max = [64, 1, 1], max_grid = [3072, 1, 1]))]
pub fn ferric_qwen3_tp_batch_swiglu_bf16_f32_v2(
    gate: &[u16],
    up: &[u16],
