...
#[cfg(test)]
macro_rules! batch_column_shape_v2 {
...
#[cfg(test)]
macro_rules! batch_partial_shape_v2 {
    ($n:expr, $k:expr, $world:expr, $projection:expr) => {
        $n == 4096
            && (($world == 1
...
#[cfg(test)]
macro_rules! batch_four_dots_v2 {
...
#[cfg(test)]
macro_rules! batch_write_bf16_v2 {
...
#[kernel(typed, launch(required = [64, 1, 1], max = [64, 1, 1], max_grid = [9496, 1, 1]), control_flow(loop_bounds(12288)))]
#[allow(clippy::too_many_arguments)]
pub fn ferric_qwen3_tp_batch_gemm_bf16_f32_bf16_v2(
    a: &[u16],
    weights: &[u16],
    ...
    let (sum_0, sum_1, sum_2, sum_3) = {
        ...
        (sum_0, sum_1, sum_2, sum_3)
        // END batch_four_dots_v2
    };
    if row_base < rows {
        {
            // BEGIN batch_write_bf16_v2
...
#[kernel(typed, launch(required = [64, 1, 1], max = [64, 1, 1], max_grid = [256, 1, 1]), control_flow(loop_bounds(12288)))]
#[allow(clippy::too_many_arguments)]
pub fn ferric_qwen3_tp_batch_gemm_partial_bf16_f32_v2(
    a: &[u16],
    weights: &[u16],
