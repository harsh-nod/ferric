...
fn main() {
    ...
    .expect("Qwen3 sharded FP32 argmax target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=54d770de20a564c808e6ebee4fbbdcd4f8c85c94da8dd33352ba9f340fe639da"
    );
}
