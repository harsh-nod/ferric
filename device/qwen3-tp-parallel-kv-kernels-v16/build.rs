...
fn main() {
    ...
    .expect("Qwen3 parallel KV append target differs from its source contract");
    ...
    println!(
        "cargo:rustc-env=FE2O3_CRATE_BINDING_ID_V1=596df219bf1db574853102c9552bc2b422d4d2c5af6a581471f9e5d9eef62c3b"
    );
}
