...
fn main() -> ExitCode {
    ...
    if env::args_os().nth(1).as_deref() == Some(m1_r33_serving_collector::COMMAND.as_ref()) {
        return m1_r33_serving_collector::main_for_arguments(env::args_os().skip(2).collect());
    }
